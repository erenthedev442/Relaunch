...
xi.settings.map =
{
    ...
    -- Maximum positive HP damage applied by a single damage event. Approved
    -- final-Prime native WSs use their own bounded job cap. Set to 0 to disable.
    -- Packet display limits remain separate.
    ...
    SPELL_RECAST_REDUCTION_CAP = 100,
    ...
    -- Audit every command issued by support GMs (GM level 1).
    -- Owner/developer GM5 commands are intentionally excluded.
    AUDIT_GM_CMD = true,
