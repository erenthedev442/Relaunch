...
weaponskillObject.onUseWeaponSkill = function(player, target, wsID, tp, primary, action, taChar)
    ...
    -- to Helheim so Resolution cannot activate another Prime weapon's AM.
    -- Lionheart receives its Aeonic aftermath from the central any-WS hook.
    if player:getEquipID(xi.slot.MAIN) == 21653 then
