-----------------------------------
-- Spell: Sandstorm II
-- Geomancy-tier weather buff (II tier). Applies the SANDSTORM_II status
-- effect to the target for 3 minutes, conferring the weather aura
-- benefits (caster's Earth-element spells gain Magic Damage and
...
spellObject.onSpellCast = function(caster, target, spell)
    local effect     = xi.effect.SANDSTORM_II
