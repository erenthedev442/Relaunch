...
-- Geomancy-tier weather buff (II tier). Applies the THUNDERSTORM_II status
-- effect to the target for 3 minutes, conferring the weather aura
-- benefits (caster's Lightning-element spells gain Magic Damage and
...
spellObject.onSpellCast = function(caster, target, spell)
    local effect     = xi.effect.THUNDERSTORM_II
