-----------------------------------
-- Spell: Rainstorm II
-- Geomancy-tier weather buff (II tier). Applies the RAINSTORM_II status
-- effect to the target for 3 minutes, conferring the weather aura
-- benefits (caster's Water-element spells gain Magic Damage and
...
spellObject.onSpellCast = function(caster, target, spell)
    local effect     = xi.effect.RAINSTORM_II
