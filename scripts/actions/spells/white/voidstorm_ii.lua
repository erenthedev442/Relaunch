-----------------------------------
-- Spell: Voidstorm II
-- Geomancy-tier weather buff (II tier). Applies the VOIDSTORM_II status
-- effect to the target for 3 minutes, conferring the weather aura
-- benefits (caster's Dark-element spells gain Magic Damage and
...
spellObject.onSpellCast = function(caster, target, spell)
    local effect     = xi.effect.VOIDSTORM_II
