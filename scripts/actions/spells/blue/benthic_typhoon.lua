-----------------------------------
-- Spell stub: Benthic Typhoon
-- AUTO-GENERATED placeholder for spell_list row id 670 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "benthic_typhoon" (id 670, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Benthic Typhoon" is not yet implemented on this server, kupo.',
