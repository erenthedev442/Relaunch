-----------------------------------
-- Spell stub: Natures Meditation
-- AUTO-GENERATED placeholder for spell_list row id 700 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "natures_meditation" (id 700, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Natures Meditation" is not yet implemented on this server, kupo.',
