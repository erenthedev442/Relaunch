-----------------------------------
-- Spell stub: Acrid Stream
-- AUTO-GENERATED placeholder for spell_list row id 656 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "acrid_stream" (id 656, group 3) -- not implemented; no effect applied')
