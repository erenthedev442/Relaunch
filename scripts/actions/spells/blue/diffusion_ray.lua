-----------------------------------
-- Spell stub: Diffusion Ray
-- AUTO-GENERATED placeholder for spell_list row id 713 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "diffusion_ray" (id 713, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Diffusion Ray" is not yet implemented on this server, kupo.',
