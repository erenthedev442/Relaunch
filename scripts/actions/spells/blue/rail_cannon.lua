-----------------------------------
-- Spell stub: Rail Cannon
-- AUTO-GENERATED placeholder for spell_list row id 712 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "rail_cannon" (id 712, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Rail Cannon" is not yet implemented on this server, kupo.',
