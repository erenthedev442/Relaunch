-----------------------------------
-- Spell stub: Evryone Grudge
-- AUTO-GENERATED placeholder for spell_list row id 683 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "evryone_grudge" (id 683, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Evryone Grudge" is not yet implemented on this server, kupo.',
