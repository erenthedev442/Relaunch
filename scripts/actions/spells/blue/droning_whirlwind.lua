-----------------------------------
-- Spell stub: Droning Whirlwind
-- AUTO-GENERATED placeholder for spell_list row id 744 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "droning_whirlwind" (id 744, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Droning Whirlwind" is not yet implemented on this server, kupo.',
