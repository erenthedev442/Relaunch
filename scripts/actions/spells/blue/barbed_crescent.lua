-----------------------------------
-- Spell stub: Barbed Crescent
-- AUTO-GENERATED placeholder for spell_list row id 699 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "barbed_crescent" (id 699, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Barbed Crescent" is not yet implemented on this server, kupo.',
