-----------------------------------
-- Spell stub: Demoralizing Roar
-- AUTO-GENERATED placeholder for spell_list row id 659 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "demoralizing_roar" (id 659, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Demoralizing Roar" is not yet implemented on this server, kupo.',
