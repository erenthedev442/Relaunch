-----------------------------------
-- Spell stub: Paralyzing Triad
-- AUTO-GENERATED placeholder for spell_list row id 704 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "paralyzing_triad" (id 704, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Paralyzing Triad" is not yet implemented on this server, kupo.',
