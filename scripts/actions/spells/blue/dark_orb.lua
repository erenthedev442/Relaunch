-----------------------------------
-- Spell stub: Dark Orb
-- AUTO-GENERATED placeholder for spell_list row id 689 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "dark_orb" (id 689, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Dark Orb" is not yet implemented on this server, kupo.',
