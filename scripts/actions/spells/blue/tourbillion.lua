-----------------------------------
-- Spell stub: Tourbillion
-- AUTO-GENERATED placeholder for spell_list row id 740 (group 3).
...
spellObject.onSpellCast = function(caster, target, spell)
    print('[spell-stub] cast of "tourbillion" (id 740, group 3) -- not implemented; no effect applied')
    if caster:getObjType() == xi.objType.PC then
        caster:printToPlayer(
            '[Spell] "Tourbillion" is not yet implemented on this server, kupo.',
