...
describe('Voidspire incoming-skill caps', function()
    it('caps deep-floor hits at 5500, including Dreadstorm', function()
        assert(catalog.outgoingDamageCap == 5500)
        local caps = catalog.skillDamageCaps
        assert(caps.Hakutaku.DeathRay == 4000)
        assert(caps.Khimaira.Fulmination >= 4000 and caps.Khimaira.Fulmination <= 5500)
        assert(caps.Khimaira.Thunderstrike >= 4000 and caps.Khimaira.Thunderstrike <= 5500)
        assert(caps.Khimaira.Dreadstorm == 5500)
        assert(caps.Cerberus.GatesOfHades >= 4000 and caps.Cerberus.GatesOfHades <= 5500)
