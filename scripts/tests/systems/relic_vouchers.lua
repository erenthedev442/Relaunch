...
describe('Hades Mail stall', function()
    it('holds at least 200 119 armor pieces with rarity prices', function()
        ...
        assert(shop.POOLS[4].key == 'crate')
        assert(shop.POOLS[5].key == 'trust')
        assert(shop.POOLS[6].key == 'cosmetic')
    ...
    it('sells Steel, Mail, Gild, Crate, Trusts, and Cosmetics together as the weekend board', function()
        local offers = hades.weekOffers(202636)
        assert(#offers == 6)
        assert(offers[1].key == 'weapon')
        assert(offers[2].key == 'armor')
        assert(offers[3].key == 'accessory')
        assert(offers[4].key == 'crate')
        assert(offers[5].key == 'trust')
        assert(offers[6].key == 'cosmetic')
        ...
        assert(offers[2].row.id == 23798)
        assert(offers[2].row.name == 'Crepuscular Mail')
        assert(offers[2].price == 557)
        assert(offers[3].row.id == 27555)
        assert(offers[3].price == 503)
        assert(offers[4].row.key == '10kbyne_50')
        assert(offers[4].price == 999)
        assert(offers[5].row.spellId == 932)
        assert(offers[5].row.name == 'Fablinix')
        assert(offers[5].price == 399)
        assert(offers[6].row.id == 11318)
        assert(offers[6].row.name == 'Otokoeshi Yukata')
        assert(offers[6].price == 299)
        ...
        assert(offers[4].row.key ~= nil)
        assert(offers[4].price == offers[4].row.price)
        assert(offers[5].row.spellId ~= nil)
        assert(offers[5].price == offers[5].row.price)
        assert(offers[6].row.id ~= nil)
