...
!!! info "How many trusts you can field at once"
    ...
    **2** on a fresh character · **3** once you [raise your Fellow to Lv100, OR Rebirth any job](fellow-companion.md) · **4** once you [conquer every Unity Wanted NM (all tiers)](../endgame/unity-concord.md) · **5** once you [clear a tier-5 Voidwatch rift](../endgame/voidwatch.md).
