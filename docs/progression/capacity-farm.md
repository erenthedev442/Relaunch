...
There are two always-up Capacity Point camps — warp to either from anywhere. Both are open to every player, no flags or quests, so you can drop in, grind a chain, and warp out whenever you like.

- Type **`!capacity`** to warp to the camp in **Bibiki Bay**.
- Type **`!ranperre`** to warp to the camp in **King Ranperres Tomb**.
...
|---|---|---|---|
| Bibiki Bay | `!capacity` | 100 phantoms, 5 looks | Lv150-160 |
| King Ranperres Tomb | `!ranperre` | 100 phantoms, 5 looks | Lv150-160 |

Claim is shared free-for-all — everyone at the camp can fight every monster, and the killer's alliance earns the Capacity Points. Bring a party, bring trusts, or solo it; each pool is sized to stay dense without ever running dry.
