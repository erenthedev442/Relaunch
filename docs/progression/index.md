...
!!! tip "Rank V notes"
    **Shinryu** at Rank V is the explicit gear-check — Lv99 with 72× HP, +2420 DEF, +10800 ATT. Bring a party.
    **Leaping Lizzy** at Rank I is the starter benchmark: Lv99, 5× HP, +2700 ATT, and +520 DEF.
...
10. **Augment your gear.** Visit the **Augment Moogle** at **<!--npc:augment_moogle-->Purgonorgo Isle<!--/npc-->** (`!hub`) to add random stats to equipment. For passive endgame bonuses, earn enough Infamy to unlock the **Augment Sage** — right beside the Moogle — Infamy comes from apex Escha - Ru'Aun NMs, Scheduled Invasions, and the weekly Raid. The Sage applies permanent stat bonuses outside the normal augment RNG.
