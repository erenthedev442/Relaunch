...
- **Trash (12 mobs)** — every trash mob carries **one fixed catalyst**; the killing blow has a **30% chance** to drop it (**×1**) into the party's **treasure pool**, so anyone in the run can lot it. Same 1:1 model as open-world catalyst mobs, so you can target a specific augment.
...
_Trash: **30%** · **×1** · to the treasure pool (anyone in the run can lot) — Boss: **×20 random** to each member, every full clear._
