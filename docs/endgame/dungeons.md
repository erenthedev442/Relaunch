...
- **Trash (12 mobs)** — every trash mob carries **one fixed catalyst**; the killing blow has a **10% chance** to drop it (**×1**) into the party's **treasure pool**, so anyone in the run can lot it. Same 1:1 model as open-world catalyst mobs, so you can target a specific augment.
- **Boss** — appears **only after you clear all 12 guardians**, so a boss kill always caps a full clear. **Every party member** then receives **20 random catalysts** from the dungeon's boss pool (each rolled independently), straight to inventory, **guaranteed on every full clear**.
...
_Trash: **10%** · **×1** · to the treasure pool (anyone in the run can lot) — Boss: **×20 random** to each member, every full clear._

**Boss pool — Mireheart Slime** (×20 random per member per clear):
...
**Boss pool — Cinderlord Ifrit** (×20 random per member per clear):
...
**Boss pool — Grieving Spirit** (×20 random per member per clear):
...
| <a class="item-link" href="https://www.ffxiah.com/item/2505" data-img="https://static.ffxiah.com/images/icon/2505.png" target="_blank" rel="noopener">Heavy Quadav Backplate</a> | Parrying rate |
...
**Boss pool — Ironclaw** (×20 random per member per clear):
...
| <a class="item-link" href="https://www.ffxiah.com/item/2543" data-img="https://static.ffxiah.com/images/icon/2543.png" target="_blank" rel="noopener">Goblin Weel</a> | Pet Store TP |
...
**Boss pool — Needleback** (×20 random per member per clear):
...
| Mob | Catalyst | Augment |
|---|---|---|
| Kuftal Worm 01 | <a class="item-link" href="https://www.ffxiah.com/item/816" data-img="https://static.ffxiah.com/images/icon/816.png" target="_blank" rel="noopener">Spool Of Silk Thread</a> | Waltz ability delay |
| Kuftal Worm 02 | <a class="item-link" href="https://www.ffxiah.com/item/817" data-img="https://static.ffxiah.com/images/icon/817.png" target="_blank" rel="noopener">Spool Of Grass Thread</a> | Song recast delay |
...
**Boss pool — Frostmaw Morbol** (×20 random per member per clear):
...
**Boss pool — Watcher Ahriman** (×20 random per member per clear):
