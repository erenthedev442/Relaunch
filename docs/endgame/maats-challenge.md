...
## The reward: Maat's Cap

Maat's Cap is a rare, EX item — it cannot be auctioned, traded, or stored.

When you **hold Maat's Cap in your inventory** and trade gear + catalysts to the **Augment Moogle**, your augment is guaranteed to be a **critical** — the 2× multiplier applies automatically, no roll required.
...
!!! info "How critical augments work"
    A critical augment doubles the exdata boost applied to every catalyst in that trade. Normally this relies on your Augment Sage rank and a random roll — Maat's Cap bypasses that entirely. See [Augment Moogle](../progression/augments.md) and [Augment Sage](../progression/augment-sage.md) for the full system details.
