...
Walk Of Echoes. Beat the Guardian of any weapon and you complete the last trial
on the Prime Weapon path.

!!! tip "Summary"
    Pick a weapon type at the Weapon Mastery Sage in <!--npc:job_mastery-->Purgonorgo Isle<!--/npc-->, fight its Guardian
...
|---|---|
| **Sword** | Guardian of the Blade |
| **Dagger** | Guardian of the Shadow |
| **Grt.Sword** | Guardian of Ruin |
| **Axe** | Guardian of the Axe |
| **Grt.Axe** | Guardian of the Vanguard |
| **Scythe** | Guardian of Catastrophe |
| **Polearm** | Guardian of the Dragon |
| **Katana** | Void Blade Guardian |
| **Grt.Katana** | Guardian of the Kensei |
...
When a Guardian appears it carries one of these affixes, rolled at random and shown to you as it spawns. Every affix piles real offense on top of the Guardian's base power, so there is no "safe" roll:
