...
- **Fast leveling, real endgame.** 3× mob EXP (plus 3× from books, FoV/GoV & Records of Eminence) gets you to 99 in an afternoon, not months. Then the *actual* game begins — dozens of custom systems built for the long haul.
...
:wolf: **Custom Trusts** — Allies you won't find on retail: **Gemma**, **Meat**, **Corvus** — from a full healer / buffer / debuffer in a deceptively small package to an unkillable wall that never drops aggro, each earned through Hunting League progression.
...
|---|---|
| EXP (mob kills) | 3× |
| EXP (scripted: books, FoV/GoV, RoE) | 3× |
| Capacity Points (scripted) | 3× |
| Sparks | 3× |
| Gil from quests | 1× |
| Magic / WS power | 1× |
| Mob drop rate | 1× |
| Starting level cap | 99 (no Limit Break needed) |
| Run speed | 150 base / 250 cap |
...
- :moneybag: **10 Gil** in your wallet
...
- **[Domain Invasion](endgame/domain-invasion.md)** — Five-wave events in the Escha zones (Zi'Tah / Ru'Aun alternating every 3 hours, eight times a day).
...
- **[Geas Fete](endgame/geas-fete.md)** — Escha's NM playground — and the front door to Aeonic weapons.
...
- **[Live Events](endgame/live-events.md)** — Three standing bonuses on fixed clocks: a daily Happy Hour EXP and Capacity-Point boost for everyone online, a Divergence City of the Day that pays bonus…
- **[Maat's Challenge](endgame/maats-challenge.md)** — Talk to Maat's Echo in Ru'Lude Gardens, pay the Infamy entry fee (stat table below), and you'll be teleported to Waughroon Shrine to face a boosted Maat — now…
- **[Nyzul Isle](endgame/nyzul-isle.md)** — No Assault rank, no Imperial Standing, no prior quest chain — just talk and enter.
- **[Omen](endgame/omen.md)** — The chessboard awaits.
...
- **[Unity Concord](endgame/unity-concord.md)** — Hunt Wanted NMs at their retail homes across Vana'diel to earn Unity Accolades, then spend them in the board's shop.
...
- **[Reforge System](progression/reforge.md)** — Warp to the Reforge hub with !reforged and talk to any NM Spawner station.
...
- **[Aeonic Weapons](progression/aeonic-weapons.md)** — The 119III relics — Godhands, Aeneas, Sequence, and the rest — are relaunch's
- **[Capacity Point Farms](progression/capacity-farms.md)** — Two always-open camps built for one thing: turning time into Job Points.
- **[Trust](progression/trusts.md)** — Every trust is learnable from day 1 — the ladder below caps how many you can summon simultaneously.

### Economy & services

- **[Auction House](economy/auction-house.md)** — Relaunch's Auction House never runs dry: a server-side market maker keeps the
- **[Cosmetic Boutique — Boutique Moogle](economy/cosmetic-boutique.md)** — A new cosmetic is featured every day (resets 00:00 UTC).
- **[Crafted Gear](economy/crafted-gear.md)** — Some of the strongest equipment on the server never drops from a monster and
- **[Gil Exchange — turning gil into Hunt Marks](economy/gil-exchange.md)** — A gil sink in Purgonorgo Isle that buys Hunt Marks with your spare gil at intentionally poor rates — for players drowning in gil who still want progression.
- **[Home Point Network — Purgonorgo Isle](economy/home-point.md)** — A Home Point crystal in Purgonorgo Isle.
- **[Race Changer](economy/race-changer.md)** — Pay a one-time gil fee at the Race Changer in Purgonorgo Isle to switch your race and face — instant, cosmetic, and nothing else about your character changes.
...
- **[Sparks Exchange — Eminence Broker](economy/sparks-exchange.md)** — Trade Sparks of Eminence, Unity Accolades, Job Points, or Hunting Marks for gil at the Eminence Broker in Purgonorgo Isle — pick a preset amount or cash out…
