...
You start at level **1** — but with every job and subjob already unlocked and **<!--setting:map.EXP_RATE-->3<!--/setting-->× mob EXP** (plus <!--setting:main.EXP_RATE:int-->3<!--/setting-->× from books & RoE), the climb is hours, not weeks.
