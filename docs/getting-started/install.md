...
You need a working **retail FFXI client** plus a third-party launcher (Ashita or Windower) to play on Legendary. If you've already got the game running for retail or another private server, you have everything you need — skip ahead to [Connect to the Server](connect.md).
...
4. **Continue to [Connect to the Server](connect.md)** to point the launcher at Legendary.
