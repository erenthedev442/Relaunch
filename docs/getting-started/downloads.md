...
| [`augment_browser.zip`](../assets/downloads/augment_browser.zip) | **AugmentBrowser** Windower addon (`//ab`) — browse the augment catalog, tiers, and your Sage rank in-game | 7 KB | `25ca8bb289ab` |
| [`augment_trade.zip`](../assets/downloads/augment_trade.zip) | **AugmentTrade** Windower addon (`//at`) — plan and stage catalyst trades for the Augment Moogle | 8 KB | `a52e1d547c41` |
