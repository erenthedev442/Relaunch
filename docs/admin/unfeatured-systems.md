# Unfeatured Systems — drift check

!!! note "Auto-generated — do not edit by hand"
    Maintained by `tools/docgen/generators/differentiators.py`. It lists system
    detail pages that exist but **aren't** represented on
    [Why Legendary?](../why-legendary.md). When this list is empty, the
    highlights page is in sync with the live systems. To clear an entry, either
    feature it in `tools/docgen/systems_registry.py` or mark it intentionally
