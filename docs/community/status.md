...
**35** online · **285** characters · _snapshot from the last site rebuild — the header badge shows live status._
...
| **Database backup + verify** | nightly 04:00 | 18d 9h ago | 🔴 **STALE** — no run in 18d 9h |
