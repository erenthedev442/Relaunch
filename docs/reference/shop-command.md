...
<div class="st-tabs">  <button class="st-tab active" data-cat="general">General</button>
  ...
  <button class="st-tab" data-cat="armor_rings">Armor: Rings</button>
  <button class="st-tab" data-cat="armor_pearls">Armor: Pearls</button>
  <button class="st-tab" data-cat="armor_accessories">Armor: Accessories</button>
  <button class="st-tab" data-cat="armor_combat">Armor: Ammo & Grips</button>
