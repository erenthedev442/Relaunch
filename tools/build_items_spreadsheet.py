...
ROLE_JOBS = {'DPS':['WAR','MNK','THF','DRK','BST','BRD','RNG','SAM','NIN','DRG','BLU','COR','DNC','PUP','RUN'],'WS':['WAR','MNK','THF','DRK','BST','BRD','RNG','SAM','NIN','DRG','BLU','COR','DNC','PUP','RUN'],'TANK':['PLD','RUN','WAR','NIN'],'CASTER':['BLM','SCH','GEO','SMN','RDM'],'HEAL':['WHM','SCH','RDM','BRD','GEO'],'PET':['SMN','BST','PUP']}
ROLE_MASKS = {r: sum(JOB[j] for j in js) for r, js in ROLE_JOBS.items()}
ROLE_WEIGHTS = {'DPS':{8:2.0,9:2.0,23:1.0,25:1.5,62:5.0,73:2.0,165:4.0,259:8.0,288:6.0,302:8.0,384:0.05,289:0.5,387:-3.0,421:1.5,160:-0.03,161:-0.03},'WS':{8:2.0,9:2.0,23:1.5,25:1.5,165:2.0,421:3.0,345:0.04,840:5.0,841:3.0,570:1.0,1144:3.0,949:5.0},'TANK':{10:2.0,2:0.5,3:3.0,1:1.0,63:3.0,27:3.0,29:3.0,387:-8.0,389:-8.0,160:-0.06,161:-0.06,162:-0.04,163:-0.06,164:-0.04,190:-0.08,831:-0.08},'CASTER':{12:2.0,13:1.0,28:3.0,30:2.0,311:4.0,170:2.0,5:0.05,6:1.0,160:-0.03,163:-0.03},'HEAL':{13:2.0,14:0.5,5:0.05,6:1.5,369:30.0,374:2.0,170:2.0,30:1.0,160:-0.03,163:-0.03},'PET':{126:4.0,994:3.0,990:1.5,991:1.5,992:1.5,993:1.5,995:1.0,117:2.0,346:2.0,357:1.5,541:1.5,1040:5.0,5:0.03,6:0.5}}
DD_ALWAYS_LATENTS = {7, 10, 41}
MOD_SANITY_CAP = {62:30,63:30,165:20,170:30,259:15,288:20,302:20,369:10,384:300,387:30,389:30,421:30,570:50,840:50,841:50,345:500,160:5000,161:5000,162:5000,163:5000,164:5000,190:8750,831:8750,1144:100,949:10}
...
MOD_SANITY_CAP.update({126:50,990:50,991:50,992:50,993:50,994:50,995:50,117:100,346:30,357:100,541:100,1040:10})
