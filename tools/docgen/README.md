...
The player-facing site at https://www.ffxi-legendary.com/ is built from `docs/` by MkDocs. Some pages are written by hand; some have auto-generated sections from the server's source data (`sql/`, `scripts/commands/`, `settings/`, `modules/custom/`, etc.).
