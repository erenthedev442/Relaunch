...
local HNM_KING_IDS = {
    [dragonsAeryID.mob.FAFNIR]           = 'Fafnir',
    [dragonsAeryID.mob.NIDHOGG]          = 'Nidhogg',
    [valleySorrowsID.mob.ADAMANTOISE]    = 'Adamantoise',
    [valleySorrowsID.mob.ASPIDOCHELONE]  = 'Aspidochelone',
    [behemothDomID.mob.BEHEMOTH]         = 'Behemoth',
    [behemothDomID.mob.KING_BEHEMOTH]    = 'King Behemoth',
}
...
hnmSystem:addOverride('xi.mob.onMobDeathEx', function(mob, player, isKiller, isWeaponSkillKill)
    ...
    local kingName = HNM_KING_IDS[mob:getID()]
