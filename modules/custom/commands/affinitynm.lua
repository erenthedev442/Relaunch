...
local nms =
{
    ...
    { 'Genbu',            'Defense',    "Shrine of Ru'Avitau",   178,  867.91, 99.50, 697.97 },
    { 'Roc',              'AGI',        'Sauromugue Champaign',  120,  263.57, -0.01, -321.78 },
    { 'Seiryu',           'Evasion',    "Shrine of Ru'Avitau",   178,  876.03, 99.50, 676.05 },
    { 'Byakko',           'Haste',      "Shrine of Ru'Avitau",   178,  875.53, 99.50, 647.75 },
    { 'Aspidochelone',    'INT',        'Cape Teriggan',         113, -156.82, 7.68, -221.20 },
    { 'Ouryu',            'Magic Atk',  'Riverne-Site B01',       29,  594.91, 0.56, -530.92 },
    { 'Bune',             'MND',        'The Boyahda Tree',      153,  374.34, 11.40, -91.05 },
    { 'Phoenix',          'Healing',    'Riverne-Site A01',       30,  656.94, -31.76, -481.88 },
    { 'Suzaku',           'CHR',        "Shrine of Ru'Avitau",   178,  856.35, 99.79, 629.97 },
    { 'Kirin',            'Enmity',     "Shrine of Ru'Avitau",   178,  840.86, 99.50, 603.89 },
    { 'Fafnir',           'HP',         "Dragon's Aery",         154,  46.41, 6.00, 33.92 },
    { 'Nidhogg',          'Regen',      "Dragon's Aery",         154,  47.57, 6.00, 24.11 },
