...
do
    ...
    -- Spalirisos (21730) moved to Prime Armory.
...
do
    ...
    -- Varga Purnikawa (21535) moved to Prime Armory.
    ...
    -- Mpu Gandring (21590) moved to Prime Armory.
    ...
    -- Caliburnus (21646) moved to Prime Armory.
    ...
    -- Helheim (21653) moved to Prime Armory.
    ...
    -- Lorg Mor (22002) moved to Prime Armory.
    ...
    -- Opashoro (22106) moved to Prime Armory.
    ...
    -- Earp (22164) moved to Prime Armory.
