...
table.insert(b.head, { id = 25590, name = "Taliah Turban", cost = 12, jobs = 'BST/SMN/PUP' })  -- DPS score 186
...
table.insert(b.body, { id = 25790, name = "Sulevias Platemail +2", cost = 12, jobs = 'WAR/PLD/DRK/DRG' })  -- DPS score 363
...
table.insert(b.body, { id = 26849, name = "Argosy Hauberk +1", cost = 12, jobs = 'WAR/DRK/BST' })  -- DPS score 303
table.insert(b.body, { id = 25686, name = "Adhemar Jacket", cost = 12, jobs = 'MNK/THF/RNG/NIN/BLU/COR/DNC/RUN' })  -- DPS score 296
...
table.insert(b.legs, { id = 25871, name = "Taliah Seraweels", cost = 12, jobs = 'BST/SMN/PUP' })  -- DPS score 190
...
table.insert(b.feet, { id = 27382, name = "Carmine Greaves", cost = 12, jobs = 'RDM/PLD/DRK/RNG/DRG/BLU/COR/RUN' })  -- DPS score 192
...
-- Head (11 picks, scored highest first)
table.insert(s.head, { id = 26678, name = "Carmine Mask", cost = 25, jobs = 'RDM/PLD/DRK/RNG/DRG/BLU/COR/RUN' })  -- DPS score 249
...
table.insert(s.head, { id = 26675, name = "Rao Kabuto +1", cost = 25, jobs = 'MNK/SAM/NIN/PUP' })  -- DPS score 238
...
table.insert(s.body, { id = 25796, name = "Taliah Manteel +2", cost = 25, jobs = 'BST/SMN/PUP' })  -- DPS score 341
...
table.insert(s.body, { id = 25753, name = "Jhakri Robe", cost = 25, jobs = 'BLM/RDM/BLU/SCH/GEO' })  -- DPS score 243
...
table.insert(s.hands, { id = 25834, name = "Taliah Gages +2", cost = 25, jobs = 'BST/SMN/PUP' })  -- DPS score 270
table.insert(s.hands, { id = 25831, name = "Inyanga Dastanas +2", cost = 25, jobs = 'WHM/BRD/SMN' })  -- CASTER score 237
table.insert(s.hands, { id = 27024, name = "Argosy Mufflers", cost = 25, jobs = 'WAR/DRK/BST' })  -- DPS score 236
table.insert(s.hands, { id = 25818, name = "Flamma Manopolas", cost = 25, jobs = 'WAR/PLD/DRK/SAM/DRG' })  -- TANK score 235
table.insert(s.hands, { id = 25811, name = "Ayanmo Manopolas +1", cost = 25, jobs = 'WHM/RDM/BRD/BLU/RUN' })  -- DPS score 233
table.insert(s.hands, { id = 27117, name = "Adhemar Wristbands", cost = 25, jobs = 'MNK/THF/RNG/NIN/BLU/COR/DNC/RUN' })  -- DPS score 232
table.insert(s.hands, { id = 23769, name = "Ikengas Gloves", cost = 25, jobs = 'RNG/COR' })  -- DPS score 230
table.insert(s.hands, { id = 27027, name = "Rao Kote +1", cost = 25, jobs = 'MNK/SAM/NIN/PUP' })  -- DPS score 229
...
table.insert(s.legs, { id = 27201, name = "Argosy Breeches +1", cost = 25, jobs = 'WAR/DRK/BST' })  -- DPS score 247
table.insert(s.legs, { id = 25885, name = "Taliah Seraweels +2", cost = 25, jobs = 'BST/SMN/PUP' })  -- DPS score 242
table.insert(s.legs, { id = 27301, name = "Ryuo Hakama +1", cost = 25, jobs = 'MNK/SAM/NIN/PUP' })  -- DPS score 241
table.insert(s.legs, { id = 27303, name = "Adhemar Kecks +1", cost = 25, jobs = 'MNK/THF/RNG/NIN/BLU/COR/DNC/RUN' })  -- DPS score 238
table.insert(s.legs, { id = 27324, name = "Gyve Trousers", cost = 25, jobs = 'WHM/BLM/RDM/BRD/RNG/NIN/SMN/BLU/PUP/SCH/GEO' })  -- TANK score 235
table.insert(s.legs, { id = 25842, name = "Herculean Trousers", cost = 25, jobs = 'MNK/THF/RNG/NIN/BLU/COR/PUP/DNC/RUN' })  -- TANK score 234
...
table.insert(s.feet, { id = 25952, name = "Taliah Crackows +2", cost = 25, jobs = 'BST/SMN/PUP' })  -- DPS score 281
table.insert(s.feet, { id = 27472, name = "Ryuo Sune-Ate +1", cost = 25, jobs = 'MNK/SAM/NIN/PUP' })  -- DPS score 247
table.insert(s.feet, { id = 27377, name = "Argosy Sollerets +1", cost = 25, jobs = 'WAR/DRK/BST' })  -- DPS score 246
...
table.insert(s.feet, { id = 25935, name = "Ayanmo Gambieras", cost = 25, jobs = 'WHM/RDM/BRD/BLU/RUN' })  -- DPS score 242
table.insert(s.feet, { id = 27496, name = "Herculean Boots", cost = 25, jobs = 'MNK/THF/RNG/NIN/BLU/COR/PUP/DNC/RUN' })  -- DPS score 237
table.insert(s.feet, { id = 27379, name = "Rao Sune-Ate +1", cost = 25, jobs = 'MNK/SAM/NIN/PUP' })  -- DPS score 234
...
table.insert(s.feet, { id = 25933, name = "Jhakri Pigaches", cost = 25, jobs = 'BLM/RDM/BLU/SCH/GEO' })  -- DPS score 210
...
table.insert(g.head, { id = 25574, name = "Sulevias Mask +2", cost = 50, jobs = 'WAR/PLD/DRK/DRG' })  -- DPS score 383
...
table.insert(g.head, { id = 25575, name = "Meghanada Visor +2", cost = 50, jobs = 'THF/BST/RNG/COR/DNC/RUN' })  -- DPS score 372
table.insert(g.head, { id = 23756, name = "Gletis Mask", cost = 50, jobs = 'THF/BST/DRG/BLU/DNC' })  -- DPS score 363
...
table.insert(g.body, { id = 25791, name = "Meghanada Cuirie +2", cost = 50, jobs = 'THF/BST/RNG/COR/DNC/RUN' })  -- DPS score 474
...
table.insert(g.body, { id = 23763, name = "Gletis Cuirass", cost = 50, jobs = 'THF/BST/DRG/BLU/DNC' })  -- DPS score 397
...
table.insert(g.hands, { id = 27023, name = "Souveran Handschuhs +1", cost = 50, jobs = 'WAR/PLD' })  -- TANK score 299
...
table.insert(g.feet, { id = 23784, name = "Gletis Boots", cost = 50, jobs = 'THF/BST/DRG/BLU/DNC' })  -- DPS score 386
...
table.insert(g.feet, { id = 23736, name = "Malignance Boots", cost = 50, jobs = 'MNK/RDM/THF/BST/RNG/NIN/BLU/COR/PUP/DNC' })  -- DPS score 361
table.insert(g.feet, { id = 23728, name = "Volte Sollerets", cost = 50, jobs = 'WAR/PLD/DRK' })  -- TANK score 352
table.insert(g.feet, { id = 25928, name = "Meghanada Jambeaux +1", cost = 50, jobs = 'THF/BST/RNG/COR/DNC/RUN' })  -- DPS score 352
table.insert(g.feet, { id = 25948, name = "Hizamaru Sune-Ate +2", cost = 50, jobs = 'MNK/SAM/NIN/PUP' })  -- DPS score 328
table.insert(g.feet, { id = 25946, name = "Sulevias Leggings +2", cost = 50, jobs = 'WAR/PLD/DRK/DRG' })  -- DPS score 320
table.insert(g.feet, { id = 25951, name = "Ayanmo Gambieras +2", cost = 50, jobs = 'WHM/RDM/BRD/BLU/RUN' })  -- DPS score 309
table.insert(g.feet, { id = 25950, name = "Jhakri Pigaches +2", cost = 50, jobs = 'BLM/RDM/BLU/SCH/GEO' })  -- DPS score 305
...
table.insert(inf.feet, { id = 25947, name = "Meghanada Jambeaux +2", cost = 500, jobs = 'THF/BST/RNG/COR/DNC/RUN' })  -- DPS score 394
table.insert(inf.feet, { id = 23786, name = "Mpacas Boots", cost = 500, jobs = 'MNK/SAM/NIN/PUP' })  -- DPS score 391
