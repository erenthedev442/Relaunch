...
catalog.vendorItems =
{
    ...
    { id = 26022, sub = "Neck", name = "Vim Torque +1", cost = 3000, stats = { 'Neck. DEF+15.', 'Regain+20 while weapon drawn (latent).' } },
    { id = 21431, sub = "Ear", name = "Coiste Bodhar", cost = 3000, stats = { 'Earring. Double Attack + WS damage.', 'Top DD earring (Omen).' } },
    { id = 26108, sub = "Ear", name = "Odr Earring", cost = 3000, stats = { 'DPS score 55', 'Accessory top-5 (ear)', 'Jobs: MNK/THF/RNG/NIN/BLU/COR/DNC/RUN' } },
    { id = 26118, sub = "Ear", name = "Sroda Earring", cost = 3000, stats = { 'Earring. STR + WS damage.', 'DD earring.' } },
    { id = 26227, sub = "Ring", name = "Cornelia\'s Ring", cost = 3000, stats = { 'Ring. Best WS-damage ring (WS damage +10%, WS Acc+20).', 'EX/RARE.' } },
    { id = 13566, sub = "Ring", name = "Defending Ring", cost = 3000, stats = { 'Damage Taken -10%.', 'Locks itself once equipped.', 'The grand prize.' } },
    { id = 26231, sub = "Ring", name = "Ephramad's Ring", cost = 3000, stats = { 'Ring. MND+15, Cure Potency+10%, Healing Skill+15.', 'EX/RARE.' } },
    { id = 26230, sub = "Ring", name = "Fickblix's Ring", cost = 3000, stats = { 'Ring. INT+15, Magic Atk+15, Magic Acc+20.', 'EX/RARE.' } },
    { id = 28471, sub = "Ring", name = "Gere Ring", cost = 3000, stats = { 'DPS score 76', 'Accessory top-5 (ring)', 'Jobs: MNK/THF/BST/NIN/PUP/DNC' } },
    { id = 26226, sub = "Ring", name = "Gurebu's Ring", cost = 3000, stats = { 'Ring. STR+10, VIT+10, Double Attack+5%.', 'EX/RARE.' } },
    { id = 26229, sub = "Ring", name = "Lehko's Ring", cost = 3000, stats = { 'Ring. DEX+10, AGI+10, Store TP+5, Haste+2%.', 'EX/RARE.' } },
    { id = 26225, sub = "Ring", name = "Medada's Ring", cost = 3000, stats = { 'Ring. STR+10, Acc+15, Crit Rate+3%.', 'EX/RARE.' } },
    { id = 26190, sub = "Ring", name = "Moonlight Ring", cost = 3000, stats = { 'Ring. Hybrid (DT-, Accuracy).', 'Universal ring.' } },
    { id = 26228, sub = "Ring", name = "Ragelise's Ring", cost = 3000, stats = { 'Ring. HP+30, DEF+20, MND+10.', 'EX/RARE.' } },
    ...
    { id = 11007, sub = "Back", name = "Letalis Mantle", cost = 3000, stats = { 'Back. DD cape (STR, Double Attack).', 'EX/RARE.' } },
    { id = 26265, sub = "Back", name = "Lugh's Cape", cost = 4000, stats = { 'Back. SCH JSE cape. DEF+15.', 'Skillchain Bonus+10, Regen dur+15.' } },
    { id = 26269, sub = "Back", name = "Moonlight Cape", cost = 3000, stats = { 'TANK score 171', 'Accessory top-5 (back)', 'Jobs: All' } },
    ...
    { id = 942, sub = "Other", name = "Philosopher's Stone", cost = 3000, stats = { 'Augment catalyst: Capacity Point +33%.', 'Alchemy material / stacks to 12.' } },
    ...
    { id = 23710, cat = 'Armor', sub = "Head", name = "Volte Beret", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WHM/BLM/RDM/BRD/SMN/SCH/GEO' } },
    { id = 23711, cat = 'Armor', sub = "Head", name = "Volte Tiara", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/MNK/RDM/THF/PLD/DRK/BST/BRD/RNG/SAM/NIN/DRG/BLU/COR/PUP/DNC/RUN' } },
    { id = 23712, cat = 'Armor', sub = "Head", name = "Volte Salade", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/PLD/DRK' } },
    { id = 23713, cat = 'Armor', sub = "Head", name = "Volte Cap", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: All jobs' } },
    { id = 23714, cat = 'Armor', sub = "Body", name = "Volte Doublet", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WHM/BLM/RDM/BRD/SMN/SCH/GEO' } },
    { id = 23715, cat = 'Armor', sub = "Body", name = "Volte Harness", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/MNK/RDM/THF/PLD/DRK/BST/BRD/RNG/SAM/NIN/DRG/BLU/COR/PUP/DNC/RUN' } },
    { id = 23716, cat = 'Armor', sub = "Body", name = "Volte Haubert", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/PLD/DRK' } },
    { id = 23717, cat = 'Armor', sub = "Body", name = "Volte Jupon", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: All jobs' } },
    { id = 23718, cat = 'Armor', sub = "Hands", name = "Volte Gloves", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WHM/BLM/RDM/BRD/SMN/SCH/GEO' } },
    { id = 23719, cat = 'Armor', sub = "Hands", name = "Volte Mittens", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/MNK/RDM/THF/PLD/DRK/BST/BRD/RNG/SAM/NIN/DRG/BLU/COR/PUP/DNC/RUN' } },
    { id = 23720, cat = 'Armor', sub = "Hands", name = "Volte Moufles", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/PLD/DRK' } },
    { id = 23721, cat = 'Armor', sub = "Hands", name = "Volte Bracers", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: All jobs' } },
    { id = 23722, cat = 'Armor', sub = "Legs", name = "Volte Brais", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WHM/BLM/RDM/BRD/SMN/SCH/GEO' } },
    { id = 23723, cat = 'Armor', sub = "Legs", name = "Volte Tights", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/MNK/RDM/THF/PLD/DRK/BST/BRD/RNG/SAM/NIN/DRG/BLU/COR/PUP/DNC/RUN' } },
    { id = 23724, cat = 'Armor', sub = "Legs", name = "Volte Brayettes", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/PLD/DRK' } },
    { id = 23725, cat = 'Armor', sub = "Legs", name = "Volte Hose", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: All jobs' } },
    { id = 23726, cat = 'Armor', sub = "Feet", name = "Volte Gaiters", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WHM/BLM/RDM/BRD/SMN/SCH/GEO' } },
    { id = 23727, cat = 'Armor', sub = "Feet", name = "Volte Spats", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/MNK/RDM/THF/PLD/DRK/BST/BRD/RNG/SAM/NIN/DRG/BLU/COR/PUP/DNC/RUN' } },
    { id = 23728, cat = 'Armor', sub = "Feet", name = "Volte Sollerets", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: WAR/PLD/DRK' } },
    { id = 23729, cat = 'Armor', sub = "Feet", name = "Volte Boots", cost = 5000, stats = { 'Volte set (Dynamis [D] armor)', 'Jobs: All jobs' } },
