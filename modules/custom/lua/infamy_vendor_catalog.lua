...
catalog.vendorItems =
{
    ...
    { id = 22300, name = 'Crepuscular Pebble',   cost = 10000, stats = { 'Ammo, all jobs (Lv.99). STR+3, VIT+3, Phys. dmg. limit +5%.', 'Ex/Rare melee ammo -- raises the physical damage cap. (-300 DMG is ranged-only.)' } },
