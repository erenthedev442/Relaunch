...
catalog.fights =
{
    ...
    warriors_path =
    {
        ...
        entryPosByArea =
        {
            -- Area 1: on the airship deck (wood). Old Z=486 was ~46' off the stern.
            [1] = { -644.9322, -231.2386, 532.4650, 215 },
            [2] = {   -4.9322, -151.2386, 172.4650, 215 },
    ...
    one_to_be_feared =
    {
        ...
        entryPosByArea =
        {
            -- Area 1 measured on-deck (Mitchum, wood, floor 0). Z=486 dumped
            -- the party off the airship. Area 2 is the same copy offset.
            [1] = { -644.9322, -231.2386, 532.4650, 45 },
            [2] = {   -4.9322, -151.2386, 172.4650, 45 },
            [3] = {  638.3754, -231.3476, 529.7620, 65 },
        },
    },
    head_wind =
