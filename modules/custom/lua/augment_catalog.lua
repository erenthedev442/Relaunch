...
return {
    ...
    [1293] = { augId = 370,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Reverse Flourish' },
    ...
    [840]  = { augId = 44,   base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 0, label = 'Store TP Subtle Blow', maxBoost = 14 },
    ...
    [865]  = { augId = 332,  base = 1,   mult = 100, disp = 100,  cat = 2, tier = 0, label = 'Sklchn.dmg', maxBoost = 9 },
    ...
    [2776] = { augId = 334,  base = 1,   mult = 1,   disp = 1,    cat = 3, tier = 0, label = 'Magic burst dmg', maxBoost = 9 },
    ...
    [1850] = { augId = 1370, base = 1,   mult = 10,  disp = 1,    cat = 3, tier = 0, label = 'Enhances', maxBoost = 7 },
    ...
    [2158] = { augId = 1156, base = 3,   mult = 30,  disp = 100,  cat = 4,  tier = 0, label = 'Magic Damage Taken' },
    [771]  = { augId = 363,  base = 1,   mult = 1,   disp = 1,    cat = 4,  tier = 0, label = 'Chance of successful block', maxBoost = 9 },
    ...
    [775]  = { augId = 1247, base = 3,   mult = 30,  disp = 100,  cat = 7, tier = 0, label = 'Pet Magic Dmg. Taken' },
    ...
    [1445] = { augId = 369,  base = 1,   mult = 1,   disp = 1,    cat = 7, tier = 0, label = 'Avatar Blood Pact Dmg', maxBoost = 11 },
    [1979] = { augId = 1246, base = 3,   mult = 30,  disp = 100,  cat = 7, tier = 0, label = 'Pet Phy. Dmg. Taken' },
    ...
    [833]  = { augId = 329,  base = 1,   mult = 1,   disp = 1,    cat = 8, tier = 0, label = 'Cure potency', maxBoost = 14 },
    ...
    [791]  = { augId = 52,   base = 1,   mult = 4,   disp = 1,    cat = 8, tier = 0, label = 'MP recovered while healing', maxBoost = 15 },
    [919]  = { augId = 138,  base = 1,   mult = 2,   disp = 1,    cat = 8, tier = 0, label = 'Refresh', maxBoost = 4 },
    ...
    [1591] = { augId = 354,  base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 0, label = 'Quadruple Attack', maxBoost = 2 },
