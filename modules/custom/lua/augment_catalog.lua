...
return {
    ...
    [1628] = { augId = 550,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'STR DEX' },
    [1640] = { augId = 551,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'STR VIT' },
    [1680] = { augId = 552,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'STR AGI' },
    [1816] = { augId = 557,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'STR CHR' },
    [2121] = { augId = 558,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'STR INT' },
    [2123] = { augId = 559,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'STR MND' },
    ...
    [2015] = { augId = 1027, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Dragon Kick DMG' },
    [2229] = { augId = 1028, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Viper Bite DMG' },
    [2365] = { augId = 1029, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Shadowstitch DMG' },
    [843]  = { augId = 1030, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Cyclone DMG' },
    [866]  = { augId = 1031, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Evisceration DMG' },
    [1155] = { augId = 1032, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Burning Blade DMG' },
    [1157] = { augId = 1033, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Shining Blade DMG' },
    [1455] = { augId = 1034, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Circle Blade DMG' },
    [1456] = { augId = 1035, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Savage Blade DMG' },
    [1466] = { augId = 1036, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Freezebite DMG' },
    [1469] = { augId = 1037, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Shockwave DMG' },
    [1517] = { augId = 1038, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Ground Strike DMG' },
    [1618] = { augId = 1039, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Sickle Moon DMG' },
    [1626] = { augId = 1040, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Gale Axe DMG' },
    [1650] = { augId = 1041, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Spinning Axe DMG' },
    [1700] = { augId = 1042, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Calamity DMG' },
    [1703] = { augId = 1043, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Decimation DMG' },
    [1704] = { augId = 1044, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Iron Tempest DMG' },
    [1719] = { augId = 1045, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Sturmwind DMG' },
    [1852] = { augId = 1046, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Keen Edge DMG' },
    [1855] = { augId = 1047, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Steel Cyclone DMG' },
    [1871] = { augId = 1048, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Nightmare Scythe DMG' },
    [1875] = { augId = 1049, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Spinning Scythe DMG' },
    [1885] = { augId = 1050, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Vorpal Scythe DMG' },
    [1899] = { augId = 1051, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Spiral Hell DMG' },
    [1900] = { augId = 1052, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Leg Sweep DMG' },
    [2175] = { augId = 1053, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Vorpal Thrust DMG' },
    [2488] = { augId = 1054, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Skewer DMG' },
    [2849] = { augId = 1055, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Impulse Drive DMG' },
    [2851] = { augId = 1056, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Blade To DMG' },
    [2859] = { augId = 1057, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Blade Chi DMG' },
    [3503] = { augId = 1058, base = 9,   mult = 1,  disp = 1,    cat = 13, label = 'Blade Ten DMG' },
