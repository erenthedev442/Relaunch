...
return {
    ...
    -- ── cat 2: Attack ─────────────────────────────────────────────────────────
    [861]  = { augId = 65,   base = 1,   mult = 2,   disp = 1,    cat = 2,  tier = 3, label = 'Attack' },
    [883]  = { augId = 66,   base = 1,   mult = 2,   disp = 1,    cat = 2,  tier = 3, label = 'Rng.Attack' },
    [874]  = { augId = 130,  base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 3, label = 'Attack Rng.Atk' },
    [880]  = { augId = 132,  base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 3, label = 'Dbl.Atk. Crit.hit rate' },
    [882]  = { augId = 143,  base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 3, label = 'Dbl.Atk' },
    [891]  = { augId = 144,  base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 4, label = 'Triple Atk' },
    ...
    [1591] = { augId = 370,  base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 0, label = 'Reverse Flourish' },
    [2711] = { augId = 1264, base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 1, label = 'Meditate Effect Duration' },

    -- ── cat 3: DEX ────────────────────────────────────────────────────────────
    [2150] = { augId = 513,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 2, label = 'DEX' },
    ...
    [840]  = { augId = 44,   base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 2, label = 'Store TP Subtle Blow' },
    [1621] = { augId = 142,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 2, label = 'Store TP' },
    [1690] = { augId = 195,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 2, label = 'Subtle Blow' },
    [926]  = { augId = 198,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'Zanshin' },
    [947]  = { augId = 251,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'Daken' },

    -- ── cat 4: Accuracy ───────────────────────────────────────────────────────
    [846]  = { augId = 62,   base = 1,   mult = 2,   disp = 1,    cat = 4,  tier = 2, label = 'Accuracy' },
    [847]  = { augId = 63,   base = 1,   mult = 2,   disp = 1,    cat = 4,  tier = 2, label = 'Rng.Accuracy' },
    ...
    [1619] = { augId = 139,  base = 1,   mult = 1,   disp = 1,    cat = 4,  tier = 0, label = 'Rapid Shot' },
    [1199] = { augId = 338,  base = 1,   mult = 1,   disp = 1,    cat = 4,  tier = 0, label = 'Barrage' },

    -- ── cat 5: VIT ────────────────────────────────────────────────────────────
    [773]  = { augId = 514,  base = 1,   mult = 1,   disp = 1,    cat = 5,  tier = 2, label = 'VIT' },

    -- ── cat 6: Defense ────────────────────────────────────────────────────────
    [881]  = { augId = 33,   base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 2, label = 'DEF' },
    [774]  = { augId = 1152, base = 1,   mult = 10,  disp = 1,    cat = 6,  tier = 2, label = 'DEF' },
    [769]  = { augId = 134,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 2, label = 'Mag.Def.Bns' },
    [936]  = { augId = 55,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 4, label = 'Magic dmg. taken' },
    [1193] = { augId = 56,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 1, label = 'Breath dmg. taken' },
    [858]  = { augId = 54,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 4, label = 'Phys. dmg. taken' },
    [1123] = { augId = 71,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 4, label = 'Damage Taken' },
    [2151] = { augId = 1155, base = 1,   mult = 200, disp = 100,  cat = 6,  tier = 4, label = 'Physical Damage Taken' },
    [2158] = { augId = 1156, base = 1,   mult = 200, disp = 100,  cat = 6,  tier = 4, label = 'Magic Damage Taken' },
    [770]  = { augId = 153,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 1, label = 'Shield Mastery' },
    [771]  = { augId = 363,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 1, label = 'Chance of successful block' },
    [772]  = { augId = 368,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 2, label = 'Phalanx Received' },
    [776]  = { augId = 1472, base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 1, label = 'Parrying rate' },
    [3504] = { augId = 42,   base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 2, label = 'Enemy crit. hit rate' },

    -- ── cat 7: AGI ────────────────────────────────────────────────────────────
    [878]  = { augId = 515,  base = 1,   mult = 1,   disp = 1,    cat = 7,  tier = 2, label = 'AGI' },
    [834]  = { augId = 212,  base = 1,   mult = 1,   disp = 1,    cat = 7,  tier = 0, label = 'Recycle' },

    -- ── cat 8: Evasion ────────────────────────────────────────────────────────
    [1617] = { augId = 1153, base = 3,   mult = 1,   disp = 1,    cat = 8,  tier = 1, label = 'Evasion' },
    ...
    -- ── cat 9: Haste ──────────────────────────────────────────────────────────
    [820]  = { augId = 49,   base = 1,   mult = 2,   disp = 10.24, cat = 9,  tier = 4, label = 'Haste' },
    [821]  = { augId = 50,   base = 1,   mult = 2,   disp = 10.24, cat = 9,  tier = 0, label = 'Slow' },
    [828]  = { augId = 186,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 0, label = 'Resist Slow' },
    -- Weapon delay (melee)
    [816]  = { augId = 47,   base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    [818]  = { augId = 48,   base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    [927]  = { augId = 752,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    [1118] = { augId = 753,  base = 33,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    [1121] = { augId = 754,  base = 65,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    [1196] = { augId = 755,  base = 97,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    [1265] = { augId = 756,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    [1275] = { augId = 757,  base = 33,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    [1276] = { augId = 758,  base = 65,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    [1277] = { augId = 759,  base = 97,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (melee,not ranged)' },
    -- Weapon delay (ranged)
    [1279] = { augId = 760,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (ranged,not melee)' },
    [1280] = { augId = 761,  base = 33,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (ranged,not melee)' },
    [1281] = { augId = 762,  base = 65,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (ranged,not melee)' },
    [1282] = { augId = 763,  base = 97,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (ranged,not melee)' },
    [1283] = { augId = 764,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (ranged,not melee)' },
    [1296] = { augId = 765,  base = 33,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (ranged,not melee)' },
    [1312] = { augId = 766,  base = 65,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (ranged,not melee)' },
    [1470] = { augId = 767,  base = 97,  mult = 1,   disp = 1,    cat = 9,  tier = 3, label = 'Delay (ranged,not melee)' },
    -- Ability delays
    [876]  = { augId = 320,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 0, label = 'Blood Pact ability delay' },
    [912]  = { augId = 324,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 0, label = 'Call Beast ability delay' },
    [1623] = { augId = 325,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 0, label = 'Quick Draw ability delay' },
    [832]  = { augId = 340,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 0, label = 'Phantom Roll ability delay' },

    -- ── cat 10: INT ───────────────────────────────────────────────────────────
    [921]  = { augId = 516,  base = 1,   mult = 1,   disp = 1,    cat = 10, tier = 2, label = 'INT' },
    [2510] = { augId = 1248, base = 1,   mult = 1,   disp = 1,    cat = 10, tier = 1, label = 'Enhancing Magic Effect Duration' },
    [2640] = { augId = 1249, base = 1,   mult = 1,   disp = 1,    cat = 10, tier = 1, label = 'Helix Effect Duration' },

    -- ── cat 11: Magic ATK ─────────────────────────────────────────────────────
    [886]  = { augId = 64,   base = 1,   mult = 2,   disp = 1,    cat = 11, tier = 2, label = 'Mag. Acc' },
    [905]  = { augId = 70,   base = 1,   mult = 2,   disp = 1,    cat = 11, tier = 2, label = 'Mag. Acc. Mag.Atk.Bns' },
    [909]  = { augId = 80,   base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 2, label = 'Mag. Acc./Mag. Dmg' },
    [2426] = { augId = 133,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 2, label = 'Mag.Atk.Bns' },
    [2498] = { augId = 362,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 2, label = 'Magic Damage' },
    [2427] = { augId = 140,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 2, label = 'Fast Cast' },
    [2428] = { augId = 237,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 2, label = 'Occult Acumen' },
    ...
    [2507] = { augId = 351,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 1, label = 'Occ. quickens spellcasting' },
    ...
    [2506] = { augId = 936,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Fire Affinity Magic Accuracy' },
    [2509] = { augId = 937,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Ice Affinity Magic Accuracy' },
    [2522] = { augId = 938,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Wind Affinity Magic Accuracy' },
    [2749] = { augId = 939,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Earth Affinity Magic Accuracy' },
    [2890] = { augId = 940,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Lightning Affinity Magic Accuracy' },
    [2938] = { augId = 941,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Water Affinity Magic Accuracy' },
    [3502] = { augId = 942,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Light Affinity Magic Accuracy' },
    [3930] = { augId = 943,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Dark Affinity Magic Accuracy' },
    [3941] = { augId = 960,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Fire Affinity Magic Accuracy Recast time' },
    -- Custom magic augments
    [2335] = { augId = 2044, base = 1,   mult = 15,  disp = 1,    cat = 11, tier = 3, label = 'Helix Damage',          maxBoost = 31 },
    [2531] = { augId = 2045, base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 3, label = 'Spikes Dmg',            maxBoost = 31 },
    [2875] = { augId = 2048, base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 3, label = 'Immunobreak Chance+',   maxBoost = 31 },

    -- ── cat 12: MND ───────────────────────────────────────────────────────────
    [888]  = { augId = 517,  base = 1,   mult = 1,   disp = 1,    cat = 12, tier = 2, label = 'MND' },

    -- ── cat 13: Healing ───────────────────────────────────────────────────────
    [833]  = { augId = 329,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 2, label = 'Cure potency' },
    [887]  = { augId = 356,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 2, label = 'Potency of Cure received' },
    [792]  = { augId = 289,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 1, label = 'Healing magic skill' },
    [793]  = { augId = 323,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 1, label = 'Cure spellcasting time' },
    ...
    [836]  = { augId = 342,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 0, label = 'Waltz TP cost' },
    [838]  = { augId = 347,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 0, label = 'Healing Magic Recast Delay' },

    -- ── cat 14: CHR ───────────────────────────────────────────────────────────
    [2841] = { augId = 518,  base = 1,   mult = 1,   disp = 1,    cat = 14, tier = 2, label = 'CHR' },
    ...
    -- ── cat 16: HP ────────────────────────────────────────────────────────────
    [860]  = { augId = 4,    base = 1,   mult = 4,   disp = 1,    cat = 16, tier = 3, label = 'HP' },
    [867]  = { augId = 18,   base = 1,   mult = 2,   disp = 1,    cat = 16, tier = 3, label = 'HP MP' },

    -- ── cat 17: Regen ─────────────────────────────────────────────────────────
    [848]  = { augId = 137,  base = 1,   mult = 4,   disp = 1,    cat = 17, tier = 3, label = 'Regen' },
    [850]  = { augId = 371,  base = 1,   mult = 1,   disp = 1,    cat = 17, tier = 2, label = 'Regen Potency' },
    [1122] = { augId = 51,   base = 1,   mult = 4,   disp = 1,    cat = 17, tier = 1, label = 'HP recovered while healing' },

    -- ── cat 18: MP ────────────────────────────────────────────────────────────
    [841]  = { augId = 12,   base = 1,   mult = 4,   disp = 1,    cat = 18, tier = 3, label = 'MP' },
    [791]  = { augId = 52,   base = 1,   mult = 4,   disp = 1,    cat = 18, tier = 1, label = 'MP recovered while healing' },

    -- ── cat 19: Refresh ───────────────────────────────────────────────────────
    [919]  = { augId = 138,  base = 1,   mult = 2,   disp = 1,    cat = 19, tier = 3, label = 'Refresh' },
    [1119] = { augId = 141,  base = 1,   mult = 1,   disp = 1,    cat = 19, tier = 2, label = 'Conserve MP' },

    -- ── cat 20: Pet ───────────────────────────────────────────────────────────
    -- Pet stats pulled from old cat 1
    [1615] = { augId = 97,   base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 1, label = 'Pet Attack Rng.Atk' },
    [1622] = { augId = 107,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 1, label = 'Pet Attack Rng.Atk' },
    ...
    [810]  = { augId = 336,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Sic and Ready ability delay' },
    ...
    [2173] = { augId = 2040, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Thunder Affinity' },
    -- Beast affinity
    [2518] = { augId = 2100, base = 5,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Beast Affinity',        maxBoost = 31 },

    -- ── cat 21: Ele Resist ────────────────────────────────────────────────────
    [837]  = { augId = 768,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Fire resist' },
    [918]  = { augId = 769,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Ice resist' },
    [928]  = { augId = 770,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Wind resist' },
    [937]  = { augId = 771,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Earth resist' },
    [938]  = { augId = 772,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Lightning resist' },
    [943]  = { augId = 773,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Water resist' },
    [948]  = { augId = 774,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Light resist' },
    [952]  = { augId = 775,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Dark resist' },
    [955]  = { augId = 792,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Fire,Wind,Lightning,Light resists' },
    [959]  = { augId = 793,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Ice,Earth,Water,Dark resists' },
    ...
    [1449] = { augId = 961,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Ice Affinity' },
    [1450] = { augId = 962,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Wind Affinity' },
    [1464] = { augId = 963,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Earth Affinity' },
    [1465] = { augId = 964,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Lightning Affinity' },
    [1474] = { augId = 965,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Water Affinity' },
    [1520] = { augId = 966,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Light Affinity' },
    [1614] = { augId = 967,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Dark Affinity' },
    [1624] = { augId = 969,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Ice Affinity' },
    [1625] = { augId = 970,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Wind Affinity' },
    [1631] = { augId = 971,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Earth Affinity' },
    [1632] = { augId = 972,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Lightning Affinity' },
    [1639] = { augId = 973,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Water Affinity' },
    [1651] = { augId = 974,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Light Affinity' },
    [1664] = { augId = 975,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Dark Affinity' },
    [1669] = { augId = 1001, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Ice Affinity' },
    [1687] = { augId = 1002, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Wind Affinity' },
    [1688] = { augId = 1003, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Earth Affinity' },
    [1689] = { augId = 1004, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Lightning Affinity' },
    [1712] = { augId = 1005, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Water Affintiy' },
    [1714] = { augId = 1006, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Light Affinity' },
    [1724] = { augId = 1007, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Dark Affinity' },
    [1738] = { augId = 1009, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Ice Affinity' },
    [1739] = { augId = 1010, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Wind Affinity' },
    [1831] = { augId = 1011, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Earth Affinity' },
    [1836] = { augId = 1012, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Lightning Affinity' },
    [1843] = { augId = 1013, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Water Affinity' },
    [1847] = { augId = 1014, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Light Affinity' },
    [1848] = { augId = 1015, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 0, label = 'Dark Affinity' },
    ...
    [1849] = { augId = 1158, base = 2,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Occ. Resistance to Status Ailments' },
    [1163] = { augId = 176,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Sleep' },
    [1452] = { augId = 177,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Poison' },
    [1630] = { augId = 178,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Paralyze' },
    [1638] = { augId = 179,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Blind' },
    [1667] = { augId = 180,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Silence' },
    [2337] = { augId = 181,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Virus' },
    [2549] = { augId = 182,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Petrify' },
    [2860] = { augId = 183,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Bind' },
    [784]  = { augId = 184,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Curse' },
    [797]  = { augId = 185,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Gravity' },
    [805]  = { augId = 187,  base = 1,   mult = 1,   disp = 1,    cat = 22, tier = 0, label = 'Resist Stun' },
    ...
    [1875] = { augId = 2046, base = 1,   mult = 1,   disp = 1,    cat = 23, tier = 1, label = 'Phantom Roll effect',   maxBoost = 0 },
    ...
    [1473] = { augId = 327,  base = 1,   mult = 1,   disp = 1,    cat = 24, tier = 3, label = 'Weapon skill damage' },
    [865]  = { augId = 332,  base = 1,   mult = 100, disp = 100,  cat = 24, tier = 3, label = 'Sklchn.dmg' },
