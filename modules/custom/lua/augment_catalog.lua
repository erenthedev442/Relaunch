...
return {
    ...
    [2173] = { augId = 2040, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 4, label = 'Thunder Affinity' },
    -- Beast affinity
    ...
    [1449] = { augId = 961,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Ice Affinity' },
    [1450] = { augId = 962,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Wind Affinity' },
    [1464] = { augId = 963,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Earth Affinity' },
    [1465] = { augId = 964,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Lightning Affinity' },
    [1474] = { augId = 965,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Water Affinity' },
    [1520] = { augId = 966,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Light Affinity' },
    [1614] = { augId = 967,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Dark Affinity' },
    [1624] = { augId = 969,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Ice Affinity' },
    [1625] = { augId = 970,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Wind Affinity' },
    [1631] = { augId = 971,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Earth Affinity' },
    [1632] = { augId = 972,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Lightning Affinity' },
    [1639] = { augId = 973,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Water Affinity' },
    [1651] = { augId = 974,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Light Affinity' },
    [1664] = { augId = 975,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Dark Affinity' },
    [1669] = { augId = 1001, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Ice Affinity' },
    [1687] = { augId = 1002, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Wind Affinity' },
    [1688] = { augId = 1003, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Earth Affinity' },
    [1689] = { augId = 1004, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Lightning Affinity' },
    [1712] = { augId = 1005, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Water Affintiy' },
    [1714] = { augId = 1006, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Light Affinity' },
    [1724] = { augId = 1007, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Dark Affinity' },
    [1738] = { augId = 1009, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Ice Affinity' },
    [1739] = { augId = 1010, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Wind Affinity' },
    [1831] = { augId = 1011, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Earth Affinity' },
    [1836] = { augId = 1012, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Lightning Affinity' },
    [1843] = { augId = 1013, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Water Affinity' },
    [1847] = { augId = 1014, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Light Affinity' },
    [1848] = { augId = 1015, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 4, label = 'Dark Affinity' },
    ...
    [1011] = { augId = 147,  base = 1,   mult = 1,   disp = 1,    cat = 23, tier = 0, label = 'Treasure Hunter', maxBoost = 0 },
