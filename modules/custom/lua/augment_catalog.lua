...
--             4 = rank 4 Sage      (high-tier universal: Haste, DA, Crit dmg, Dmg+)
--             5 = rank 5 Archon    (top-tier: TP Bonus, WSD, Songs+, PhantomRoll, Spikes, Immunobreak, QA)
...
return {
    ...
    [1271] = { augId = 353,  base = 1,   mult = 4,   disp = 1,    cat = 2,  tier = 5, label = 'TP Bonus' },
    [1293] = { augId = 354,  base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 5, label = 'Quadruple Attack' },
    ...
    [2711] = { augId = 1264, base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 5, label = 'Meditate Effect Duration' },
    ...
    [2149] = { augId = 328,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 5, label = 'Crit. hit damage' },
    [840]  = { augId = 44,   base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 5, label = 'Store TP Subtle Blow' },
    ...
    [1619] = { augId = 139,  base = 1,   mult = 1,   disp = 1,    cat = 4,  tier = 5, label = 'Rapid Shot' },
    [1199] = { augId = 338,  base = 1,   mult = 1,   disp = 1,    cat = 4,  tier = 5, label = 'Barrage' },
    ...
    [1193] = { augId = 56,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 5, label = 'Breath dmg. taken' },
    [858]  = { augId = 54,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 3, label = 'Phys. dmg. taken' },
    [1123] = { augId = 71,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 5, label = 'Damage Taken' },
    ...
    [770]  = { augId = 153,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 5, label = 'Shield Mastery' },
    [771]  = { augId = 363,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 5, label = 'Chance of successful block' },
    [772]  = { augId = 368,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 5, label = 'Phalanx Received' },
    ...
    [821]  = { augId = 50,   base = 1,   mult = 2,   disp = 10.24, cat = 9,  tier = 5, label = 'Slow' },
    [828]  = { augId = 186,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 5, label = 'Resist Slow' },
    -- Weapon delay (melee)
    -- Weapon delay (ranged)
    -- Ability delays
    [876]  = { augId = 320,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 5, label = 'Blood Pact ability delay' },
    [912]  = { augId = 324,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 5, label = 'Call Beast ability delay' },
    [1623] = { augId = 325,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 5, label = 'Quick Draw ability delay' },
    [832]  = { augId = 340,  base = 1,   mult = 1,   disp = 1,    cat = 9,  tier = 5, label = 'Phantom Roll ability delay' },
    ...
    [2640] = { augId = 1249, base = 1,   mult = 1,   disp = 1,    cat = 10, tier = 5, label = 'Helix Effect Duration' },

    -- ── cat 11: Magic ATK ─────────────────────────────────────────────────────
    [886]  = { augId = 64,   base = 1,   mult = 2,   disp = 1,    cat = 11, tier = 1, label = 'Mag. Acc' },
    [905]  = { augId = 70,   base = 1,   mult = 2,   disp = 1,    cat = 11, tier = 5, label = 'Mag. Acc. Mag.Atk.Bns' },
    ...
    [2428] = { augId = 237,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 5, label = 'Occult Acumen' },
    ...
    [2507] = { augId = 351,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 5, label = 'Occ. quickens spellcasting' },
    ...
    [3941] = { augId = 960,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 5, label = 'Fire Affinity Magic Accuracy Recast time' },
    -- Custom magic augments
    [2335] = { augId = 2044, base = 1,   mult = 15,  disp = 1,    cat = 11, tier = 5, label = 'Helix Damage',          maxBoost = 31 },
    ...
    [793]  = { augId = 323,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 5, label = 'Cure spellcasting time' },
    [1741] = { augId = 330,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 1, label = 'Waltz potency' },
    [801]  = { augId = 331,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 5, label = 'Waltz ability delay' },
    [836]  = { augId = 342,  base = 1,   mult = 1,   disp = 1,    cat = 13, tier = 5, label = 'Waltz TP cost' },
    ...
    -- ── cat 17: Regen ─────────────────────────────────────────────────────────
    [848]  = { augId = 137,  base = 1,   mult = 4,   disp = 1,    cat = 17, tier = 5, label = 'Regen' },
    ...
    [1268] = { augId = 952,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Fire Affinity Avatar perp. cost' },
    [1270] = { augId = 953,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Ice Affinity Avatar perp. cost' },
    [1295] = { augId = 954,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Wind Affinity Avatar perp. cost' },
    [1311] = { augId = 955,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Earth Affinity Avatar perp. cost' },
    [1313] = { augId = 957,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Water Affinity Avatar perp. cost' },
    [1414] = { augId = 958,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Light Affinity Avatar perp. cost' },
    [1443] = { augId = 959,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Dark Affinity Avatar perp. cost' },
    [1830] = { augId = 956,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Thunder Affinity Avatar perp. cost' },
    [2173] = { augId = 2040, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Thunder Affinity' },
    -- Beast affinity
    [2518] = { augId = 2100, base = 5,   mult = 1,   disp = 1,    cat = 20, tier = 5, label = 'Beast Affinity',        maxBoost = 31 },
    ...
    [1165] = { augId = 928,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Fire Affinity' },
    [1186] = { augId = 929,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Ice Affinity' },
    [1187] = { augId = 930,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Wind Affinity' },
    [1200] = { augId = 931,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Earth Affinity' },
    [1201] = { augId = 932,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Lightning Affinity' },
    [1236] = { augId = 933,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Water Affinity' },
    [1237] = { augId = 934,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Light Affinity' },
    [1263] = { augId = 935,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Dark Affinity' },
    [1449] = { augId = 961,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Ice Affinity' },
    [1450] = { augId = 962,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Wind Affinity' },
    [1464] = { augId = 963,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Earth Affinity' },
    [1465] = { augId = 964,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Lightning Affinity' },
    [1474] = { augId = 965,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Water Affinity' },
    [1520] = { augId = 966,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Light Affinity' },
    [1614] = { augId = 967,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Dark Affinity' },
    [1624] = { augId = 969,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Ice Affinity' },
    [1625] = { augId = 970,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Wind Affinity' },
    [1631] = { augId = 971,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Earth Affinity' },
    [1632] = { augId = 972,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Lightning Affinity' },
    [1639] = { augId = 973,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Water Affinity' },
    [1651] = { augId = 974,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Light Affinity' },
    [1664] = { augId = 975,  base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Dark Affinity' },
    [1669] = { augId = 1001, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Ice Affinity' },
    [1687] = { augId = 1002, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Wind Affinity' },
    [1688] = { augId = 1003, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Earth Affinity' },
    [1689] = { augId = 1004, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Lightning Affinity' },
    [1712] = { augId = 1005, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Water Affintiy' },
    [1714] = { augId = 1006, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Light Affinity' },
    [1724] = { augId = 1007, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Dark Affinity' },
    [1738] = { augId = 1009, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Ice Affinity' },
    [1739] = { augId = 1010, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Wind Affinity' },
    [1831] = { augId = 1011, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Earth Affinity' },
    [1836] = { augId = 1012, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Lightning Affinity' },
    [1843] = { augId = 1013, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Water Affinity' },
    [1847] = { augId = 1014, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Light Affinity' },
    [1848] = { augId = 1015, base = 1,   mult = 1,   disp = 1,    cat = 21, tier = 5, label = 'Dark Affinity' },
    ...
    [865]  = { augId = 332,  base = 1,   mult = 100, disp = 100,  cat = 24, tier = 5, label = 'Sklchn.dmg' },
    [889]  = { augId = 743,  base = 1,   mult = 1,   disp = 1,    cat = 24, tier = 5, label = 'Dmg (melee,not ranged)' },
}
