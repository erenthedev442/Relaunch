...
return {
    ...
    [897]  = { augId = 151,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'Martial Arts' },
    [903]  = { augId = 194,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'Kick Attacks Rate or Damage' },
    [926]  = { augId = 198,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'Zanshin' },
    [947]  = { augId = 251,  base = 1,   mult = 1,  disp = 1,    cat = 1,  label = 'Daken' },
    ...
    [2842] = { augId = 1793, base = 1,   mult = 1,  disp = 1,    cat = 2,  label = 'Pet DEX' },
    ...
    [2498] = { augId = 362,  base = 1,   mult = 1,  disp = 1,    cat = 5,  label = 'Magic Damage' },
    [921]  = { augId = 516,  base = 1,   mult = 1,  disp = 1,    cat = 5,  label = 'INT' },
    [2338] = { augId = 896,  base = 1,   mult = 1,  disp = 1,    cat = 5,  label = 'Enspell Dmg' },
    [2834] = { augId = 1157, base = 2,   mult = 1,  disp = 1,    cat = 5,  label = 'Spell Interruption Rate Down 2%' },
    [2510] = { augId = 1248, base = 1,   mult = 1,  disp = 1,    cat = 5,  label = 'Enhancing Magic Effect Duration' },
    ...
    [1015] = { augId = 294,  base = 1,   mult = 1,  disp = 1,    cat = 10, label = 'Summoning magic skill' },
    [1156] = { augId = 321,  base = 1,   mult = 1,  disp = 1,    cat = 10, label = 'Avatar perpetuation cost' },
    [1272] = { augId = 339,  base = 1,   mult = 5,  disp = 1,    cat = 10, label = 'Elemental Siphon' },
    [1445] = { augId = 369,  base = 1,   mult = 1,  disp = 1,    cat = 10, label = 'Avatar Blood Pact Dmg' },
    [1830] = { augId = 956,  base = 1,   mult = 1,  disp = 1,    cat = 10, label = 'Thunder Affinity Avatar perp. cost' },
    ...
    [1831] = { augId = 1011, base = 1,   mult = 1,  disp = 1,    cat = 11, label = 'Earth Affinity' },
    [1836] = { augId = 1012, base = 1,   mult = 1,  disp = 1,    cat = 11, label = 'Lightning Affinity' },
    [1843] = { augId = 1013, base = 1,   mult = 1,  disp = 1,    cat = 11, label = 'Water Affinity' },
    [1847] = { augId = 1014, base = 1,   mult = 1,  disp = 1,    cat = 11, label = 'Light Affinity' },
    [1848] = { augId = 1015, base = 1,   mult = 1,  disp = 1,    cat = 11, label = 'Dark Affinity' },
    [1849] = { augId = 1158, base = 2,   mult = 1,  disp = 1,    cat = 11, label = 'Occ. Resistance to Status Ailments' },
    [1850] = { augId = 1370, base = 1,   mult = 10, disp = 1,    cat = 11, label = 'Enhances' },
    ...
    [1854] = { augId = 292,  base = 1,   mult = 1,  disp = 1,    cat = 12, label = 'Elem. magic skill' },
    [2154] = { augId = 295,  base = 1,   mult = 1,  disp = 1,    cat = 12, label = 'Ninjutsu skill' },
    [2155] = { augId = 296,  base = 1,   mult = 1,  disp = 1,    cat = 12, label = 'Singing skill' },
    [2161] = { augId = 297,  base = 1,   mult = 1,  disp = 1,    cat = 12, label = 'String instrument skill' },
    [2171] = { augId = 299,  base = 1,   mult = 1,  disp = 1,    cat = 12, label = 'Blue Magic skill' },
    [2212] = { augId = 300,  base = 1,   mult = 1,  disp = 1,    cat = 12, label = 'Geomancy Skill' },
    [2334] = { augId = 301,  base = 1,   mult = 1,  disp = 1,    cat = 12, label = 'Handbell Skill' },
    ...
    -- Other
    [1269] = { augId = 215,  base = 1,   mult = 1,  disp = 1,    cat = 14, label = 'Ninja tool expertise' },
    [2729] = { augId = 341,  base = 1,   mult = 1,  disp = 1,    cat = 14, label = 'Repair potency' },
    [2507] = { augId = 351,  base = 1,   mult = 1,  disp = 1,    cat = 14, label = 'Occ. quickens spellcasting' },
    [2641] = { augId = 1250, base = 1,   mult = 1,  disp = 1,    cat = 14, label = 'Indi Effect Duration' },
    ...
    [2875] = { augId = 2048, base = 1,   mult = 1,  disp = 1,    cat = 5,  label = 'Immunobreak Chance+', maxBoost = 31 },  -- ethereal_squama
    [2518] = { augId = 2100, base = 5,   mult = 1,  disp = 1,    cat = 10, label = 'Beast Affinity', maxBoost = 31 },  -- smilodon_hide
}
