...
return {
    ...
    [895]  = { augId = 194,  base = 1,   cat = 1,  label = 'Kick Attacks+1% (additional kick rate)' },
    ...
    [1108] = { augId = 360,  base = 10,  cat = 1,  label = 'Save TP+10' },
    ...
    [1291] = { augId = 43,   base = 1,   cat = 7,  label = 'Charm+1 (land rate)' },
