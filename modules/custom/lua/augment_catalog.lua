...
--             24 = WSD+         (Proto-Omega)
--   tier  : 0 for all augments (RELAUNCH: every augment is available at
--           every content tier). Power scales via the player's Augment Tier
--           roll band (T1:[0-5] .. T5:[25-31]) — a T1 player gets weak
--           rolls, a T5 player gets strong rolls on the same catalyst.
...
return {
    ...
    [895]  = { augId = 145,  base = 1,   mult = 1,   disp = 1,    cat = 1,  tier = 0, label = 'Counter' },
    [897]  = { augId = 151,  base = 1,   mult = 1,   disp = 1,    cat = 1,  tier = 0, label = 'Martial Arts' },
    [903]  = { augId = 194,  base = 1,   mult = 1,   disp = 1,    cat = 1,  tier = 0, label = 'Kick Attacks Rate or Damage' },
    [2147] = { augId = 640,  base = 1,   mult = 2,   disp = 1,    cat = 1,  tier = 0, label = 'Counter' },
    ...
    [2711] = { augId = 1264, base = 1,   mult = 1,   disp = 1,    cat = 2,  tier = 0, label = 'Meditate Effect Duration' },

    -- ── cat 3: DEX ────────────────────────────────────────────────────────────
    [2150] = { augId = 513,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'DEX' },
    [2148] = { augId = 41,   base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'Crit.hit rate' },
    [2149] = { augId = 328,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'Crit. hit damage' },
    [840]  = { augId = 44,   base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'Store TP Subtle Blow' },
    [1621] = { augId = 142,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'Store TP' },
    [1690] = { augId = 195,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'Subtle Blow' },
    [926]  = { augId = 198,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'Zanshin' },
    [947]  = { augId = 251,  base = 1,   mult = 1,   disp = 1,    cat = 3,  tier = 0, label = 'Daken' },

    -- ── cat 4: Accuracy ───────────────────────────────────────────────────────
    [846]  = { augId = 62,   base = 1,   mult = 2,   disp = 1,    cat = 4,  tier = 0, label = 'Accuracy' },
    [847]  = { augId = 63,   base = 1,   mult = 2,   disp = 1,    cat = 4,  tier = 0, label = 'Rng.Accuracy' },
    [1292] = { augId = 129,  base = 1,   mult = 1,   disp = 1,    cat = 4,  tier = 0, label = 'Accuracy Rng.Acc' },
    [884]  = { augId = 68,   base = 1,   mult = 1,   disp = 1,    cat = 4,  tier = 0, label = 'Accuracy Attack' },
    [1116] = { augId = 69,   base = 1,   mult = 1,   disp = 1,    cat = 4,  tier = 0, label = 'Rng.Acc. Rng.Atk' },
    ...
    -- ── cat 5: VIT ────────────────────────────────────────────────────────────
    [773]  = { augId = 514,  base = 1,   mult = 1,   disp = 1,    cat = 5,  tier = 0, label = 'VIT' },

    -- ── cat 6: Defense ────────────────────────────────────────────────────────
    [881]  = { augId = 33,   base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 0, label = 'DEF' },
    [774]  = { augId = 1152, base = 1,   mult = 10,  disp = 1,    cat = 6,  tier = 0, label = 'DEF' },
    [769]  = { augId = 134,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 0, label = 'Mag.Def.Bns' },
    [936]  = { augId = 55,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 0, label = 'Magic dmg. taken' },
    [1193] = { augId = 56,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 0, label = 'Breath dmg. taken' },
    [858]  = { augId = 54,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 0, label = 'Phys. dmg. taken' },
    [1123] = { augId = 71,   base = 1,   mult = 100, disp = 100,  cat = 6,  tier = 0, label = 'Damage Taken' },
    [2151] = { augId = 1155, base = 1,   mult = 200, disp = 100,  cat = 6,  tier = 0, label = 'Physical Damage Taken' },
    [2158] = { augId = 1156, base = 1,   mult = 200, disp = 100,  cat = 6,  tier = 0, label = 'Magic Damage Taken' },
    [770]  = { augId = 153,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 0, label = 'Shield Mastery' },
    [771]  = { augId = 363,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 0, label = 'Chance of successful block' },
    [772]  = { augId = 368,  base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 0, label = 'Phalanx Received' },
    [776]  = { augId = 1472, base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 0, label = 'Parrying rate' },
    [3504] = { augId = 42,   base = 1,   mult = 1,   disp = 1,    cat = 6,  tier = 0, label = 'Enemy crit. hit rate' },

    -- ── cat 7: AGI ────────────────────────────────────────────────────────────
    [878]  = { augId = 515,  base = 1,   mult = 1,   disp = 1,    cat = 7,  tier = 0, label = 'AGI' },
    ...
    [1713] = { augId = 1154, base = 3,   mult = 1,   disp = 1,    cat = 8,  tier = 0, label = 'Mag. Evasion' },
    [829]  = { augId = 211,  base = 1,   mult = 1,   disp = 1,    cat = 8,  tier = 0, label = 'Snapshot' },

    -- ── cat 9: Haste ──────────────────────────────────────────────────────────
    [820]  = { augId = 49,   base = 1,   mult = 2,   disp = 10.24, cat = 9,  tier = 0, label = 'Haste' },
    ...
    -- ── cat 10: INT ───────────────────────────────────────────────────────────
    [921]  = { augId = 516,  base = 1,   mult = 1,   disp = 1,    cat = 10, tier = 0, label = 'INT' },
    [2510] = { augId = 1248, base = 1,   mult = 1,   disp = 1,    cat = 10, tier = 0, label = 'Enhancing Magic Effect Duration' },
    [2640] = { augId = 1249, base = 1,   mult = 1,   disp = 1,    cat = 10, tier = 0, label = 'Helix Effect Duration' },

    -- ── cat 11: Magic ATK ─────────────────────────────────────────────────────
    [886]  = { augId = 64,   base = 1,   mult = 2,   disp = 1,    cat = 11, tier = 0, label = 'Mag. Acc' },
    [905]  = { augId = 70,   base = 1,   mult = 2,   disp = 1,    cat = 11, tier = 0, label = 'Mag. Acc. Mag.Atk.Bns' },
    [909]  = { augId = 80,   base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Mag. Acc./Mag. Dmg' },
    [2426] = { augId = 133,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Mag.Atk.Bns' },
    [2498] = { augId = 362,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Magic Damage' },
    [2427] = { augId = 140,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Fast Cast' },
    [2428] = { augId = 237,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Occult Acumen' },
    [2776] = { augId = 334,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Magic burst dmg' },
    [2777] = { augId = 335,  base = 1,   mult = 1,   disp = 1,    cat = 11, tier = 0, label = 'Mag. crit. hit dmg' },
    ...
    [867]  = { augId = 18,   base = 1,   mult = 2,   disp = 1,    cat = 16, tier = 0, label = 'HP MP' },

    -- ── cat 17: Regen ─────────────────────────────────────────────────────────
    [848]  = { augId = 137,  base = 1,   mult = 4,   disp = 1,    cat = 17, tier = 0, label = 'Regen' },
    [850]  = { augId = 371,  base = 1,   mult = 1,   disp = 1,    cat = 17, tier = 0, label = 'Regen Potency' },
    [1122] = { augId = 51,   base = 1,   mult = 4,   disp = 1,    cat = 17, tier = 0, label = 'HP recovered while healing' },

    -- ── cat 18: MP ────────────────────────────────────────────────────────────
    [841]  = { augId = 12,   base = 1,   mult = 4,   disp = 1,    cat = 18, tier = 0, label = 'MP' },
    [791]  = { augId = 52,   base = 1,   mult = 4,   disp = 1,    cat = 18, tier = 0, label = 'MP recovered while healing' },

    -- ── cat 19: Refresh ───────────────────────────────────────────────────────
    [919]  = { augId = 138,  base = 1,   mult = 2,   disp = 1,    cat = 19, tier = 0, label = 'Refresh' },
    [1119] = { augId = 141,  base = 1,   mult = 1,   disp = 1,    cat = 19, tier = 0, label = 'Conserve MP' },

    -- ── cat 20: Pet ───────────────────────────────────────────────────────────
    -- Pet stats pulled from old cat 1
    [1615] = { augId = 97,   base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Attack Rng.Atk' },
    [1718] = { augId = 109,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Dbl.Atk. Crit.hit rate' },
    [786]  = { augId = 112,  base = 1,   mult = 100, disp = 100,  cat = 20, tier = 0, label = 'Pet Damage taken' },
    [853]  = { augId = 114,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Rng.Atk' },
    [855]  = { augId = 118,  base = 1,   mult = 100, disp = 100,  cat = 20, tier = 0, label = 'Pet Phys. dmg. taken' },
    [856]  = { augId = 122,  base = 20,  mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet TP Bonus' },
    [857]  = { augId = 123,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Dbl.Att' },
    [863]  = { augId = 127,  base = 1,   mult = 100, disp = 100,  cat = 20, tier = 0, label = 'Pet Magic Damage Taken' },
    [2169] = { augId = 1806, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet STR DEX VIT' },
    ...
    [2842] = { augId = 1793, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet DEX' },
    -- Pet stats pulled from old cat 3
    [2854] = { augId = 99,   base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet DEF' },
    [768]  = { augId = 119,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Mag.Def.Bns' },
    [775]  = { augId = 1247, base = 1,   mult = 200, disp = 100,  cat = 20, tier = 0, label = 'Pet Magic Dmg. Taken' },
    [803]  = { augId = 1794, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet VIT' },
    -- Pet stats pulled from old cat 4
    [825]  = { augId = 98,   base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Evasion' },
    [826]  = { augId = 111,  base = 1,   mult = 2,   disp = 10.24, cat = 20, tier = 0, label = 'Pet Haste' },
    [827]  = { augId = 117,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Mag. Evasion' },
    [810]  = { augId = 336,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Sic and Ready ability delay' },
    [1861] = { augId = 1795, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet AGI' },
    -- Pet stats pulled from old cat 5
    [914]  = { augId = 100,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Mag.Acc' },
    [954]  = { augId = 101,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Mag.Atk.Bns' },
    [1518] = { augId = 108,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Mag.Acc. Mag.Atk.Bns' },
    [1521] = { augId = 120,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Avatar Mag.Atk.Bns' },
    [2157] = { augId = 125,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Mag.Acc. Mag.Dmg' },
    [2163] = { augId = 126,  base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet Magic Damage' },
    [2847] = { augId = 1796, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet INT' },
    -- Pet stats pulled from old cat 6
    [2198] = { augId = 1797, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet MND' },
    ...
    [2850] = { augId = 1798, base = 1,   mult = 1,   disp = 1,    cat = 20, tier = 0, label = 'Pet CHR' },
    -- Pet stats pulled from old cat 8
    [1133] = { augId = 110,  base = 1,   mult = 4,   disp = 1,    cat = 20, tier = 0, label = 'Pet Regen' },
