...
catalog.vendorItems =
{
    ...
    { id = 21084, cat = 'Weapons', sub = 'Fete T2', name = 'Queller Rod',    cost = 500 },
    { id = 20702, cat = 'Weapons', sub = 'Fete T2', name = 'Emissary',       cost = 500 },
    { id = 20598, cat = 'Weapons', sub = 'Fete T2', name = 'Shijo',          cost = 500 },
    { id = 20700, cat = 'Weapons', sub = 'Fete T2', name = 'Nixxer',         cost = 500 },
    { id = 20892, cat = 'Weapons', sub = 'Fete T2', name = 'Deathbane',      cost = 500 },
    { id = 20797, cat = 'Weapons', sub = 'Fete T2', name = 'Skullrender',    cost = 500 },
    { id = 20599, cat = 'Weapons', sub = 'Fete T2', name = 'Kali',           cost = 500 },
    { id = 21215, cat = 'Weapons', sub = 'Fete T2', name = 'Vijaya Bow',     cost = 500 },
    { id = 21027, cat = 'Weapons', sub = 'Fete T2', name = 'Ichigohitofuri', cost = 500 },
    { id = 20979, cat = 'Weapons', sub = 'Fete T2', name = 'Aizushintogo',   cost = 500 },
    { id = 20937, cat = 'Weapons', sub = 'Fete T2', name = 'Rhomphaia',      cost = 500 },
    { id = 21149, cat = 'Weapons', sub = 'Fete T2', name = 'Espiritus',      cost = 500 },
    { id = 20701, cat = 'Weapons', sub = 'Fete T2', name = 'Iris',           cost = 500 },
    { id = 20597, cat = 'Weapons', sub = 'Fete T2', name = 'Enchufla',       cost = 500 },
    { id = 21150, cat = 'Weapons', sub = 'Fete T2', name = 'Akademos',       cost = 500 },
    { id = 21085, cat = 'Weapons', sub = 'Fete T2', name = 'Solstice',       cost = 500 },
    { id = 21698, cat = 'Weapons', sub = 'Fete T2', name = 'Bidenhander',    cost = 500 },
    ...
    { id = 20579, cat = 'Weapons', sub = 'Reisenjima', name = 'Skinflayer',  cost = 2000 },
    { id = 21686, cat = 'Weapons', sub = 'Reisenjima', name = 'Zulfiqar',    cost = 2000 },
    { id = 21746, cat = 'Weapons', sub = 'Reisenjima', name = 'Digirbalag',  cost = 2000 },
    { id = 21754, cat = 'Weapons', sub = 'Reisenjima', name = 'Aganoshe',    cost = 2000 },
    { id = 21804, cat = 'Weapons', sub = 'Reisenjima', name = 'Obschine',    cost = 2000 },
    { id = 21904, cat = 'Weapons', sub = 'Reisenjima', name = 'Kanaria',     cost = 2000 },
    { id = 21021, cat = 'Weapons', sub = 'Reisenjima', name = 'Umaru',       cost = 2000 },
    { id = 21072, cat = 'Weapons', sub = 'Reisenjima', name = 'Gada',        cost = 2000 },
