...
catalog.vendorItems =
{
    ...
    { id = 21084, cat = 'Weapons', sub = 'Club', name = 'Queller Rod',    cost = 500 },
    { id = 20702, cat = 'Weapons', sub = 'Sword', name = 'Emissary',       cost = 500 },
    { id = 20598, cat = 'Weapons', sub = 'Dagger', name = 'Shijo',          cost = 500 },
    { id = 20700, cat = 'Weapons', sub = 'Sword', name = 'Nixxer',         cost = 500 },
    { id = 20892, cat = 'Weapons', sub = 'Scythe', name = 'Deathbane',      cost = 500 },
    { id = 20797, cat = 'Weapons', sub = 'Axe', name = 'Skullrender',    cost = 500 },
    { id = 20599, cat = 'Weapons', sub = 'Dagger', name = 'Kali',           cost = 500 },
    { id = 21215, cat = 'Weapons', sub = 'Archery', name = 'Vijaya Bow',     cost = 500 },
    { id = 21027, cat = 'Weapons', sub = 'Gt. Katana', name = 'Ichigohitofuri', cost = 500 },
    { id = 20979, cat = 'Weapons', sub = 'Katana', name = 'Aizushintogo',   cost = 500 },
    { id = 20937, cat = 'Weapons', sub = 'Polearm', name = 'Rhomphaia',      cost = 500 },
    { id = 21149, cat = 'Weapons', sub = 'Staff', name = 'Espiritus',      cost = 500 },
    { id = 20701, cat = 'Weapons', sub = 'Sword', name = 'Iris',           cost = 500 },
    { id = 20597, cat = 'Weapons', sub = 'Dagger', name = 'Enchufla',       cost = 500 },
    { id = 21150, cat = 'Weapons', sub = 'Staff', name = 'Akademos',       cost = 500 },
    { id = 21085, cat = 'Weapons', sub = 'Club', name = 'Solstice',       cost = 500 },
    { id = 21698, cat = 'Weapons', sub = 'Gt. Sword', name = 'Bidenhander',    cost = 500 },
    ...
    { id = 21482, cat = 'Weapons', sub = 'Marksmanship', name = 'Compensator', cost = 500 },
    { id = 20519, cat = 'Weapons', sub = 'Hand-to-Hand', name = 'Hammerfists', cost = 500 },
    { id = 20845, cat = 'Weapons', sub = 'Gt. Axe', name = 'Instigator', cost = 500 },
    { id = 21151, cat = 'Weapons', sub = 'Staff', name = 'Lathi', cost = 500 },
    { id = 20520, cat = 'Weapons', sub = 'Hand-to-Hand', name = 'Midnights', cost = 500 },
