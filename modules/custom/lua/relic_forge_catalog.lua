...
C.weapons =
{
    ...
    { id = 22129, name = 'Yoichinoyumi',   currency = 1453, currencyName = 'Montiont Silverpiece',  highCurrency = 1454, highCurrencyName = 'Ranperre Goldpiece',     info = 'Bow relic. Native WS: Namas Arrow.' },
