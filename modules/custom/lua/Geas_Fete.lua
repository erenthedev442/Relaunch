...
local NM_CATALOG = {
    ...
    [ZITAH] = {
        ...
        -- Tier 2 (retail 125) ------------------------------------------
        { name='Ionos', gid=55, tier=2, hp=640000, currency=800, cooldown=3600, drops = { { id=20524, name='Nibiru Sainti' }, { id=21216, name='Nibiru Bow' }, { id=20895, name='Nibiru Sickle' }, { id=27607, name='Thaumaturge\'s Cape' } } },
        { name='Sensual Sandy', gid=56, tier=2, hp=640000, currency=800, cooldown=3600, drops = { { id=20600, name='Nibiru Knife' }, { id=20939, name='Nibiru Lance' }, { id=21273, name='Nibiru Gun' }, { id=28417, name='Sinew Belt' } } },
        { name='Nosoi', gid=57, tier=2, hp=640000, currency=800, cooldown=3600, drops = { { id=20710, name='Nibiru Blade' }, { id=28476, name='Calamitous Earring' }, { id=20983, name='Mijin' }, { id=27642, name='Nibiru Shield' } } },
        { name='Brittlis', gid=58, tier=2, hp=640000, currency=800, cooldown=3600, drops = { { id=27554, name='Purity Ring' }, { id=21699, name='Nibiru Faussar' }, { id=21399, name='Nibiru Harp' }, { id=21031, name='Sensui' } } },
        { name='Kamohoalii', gid=59, tier=2, hp=640000, currency=800, cooldown=3600, drops = { { id=20801, name='Nibiru Tabar' }, { id=21092, name='Nibiru Cudgel' }, { id=21415, name='Forefathers\' Grip' } } },
        { name='Umdhlebi', gid=60, tier=2, hp=640000, currency=800, cooldown=3600, drops = { { id=20848, name='Nibiru Chopper' }, { id=21156, name='Nibiru Staff' }, { id=22252, name='Sapience Orb' } } },
        -- Tier 2 (relaunch originals) ----------------------------------
        { name='Keeper of Heiligtum', gid=28, tier=2, hp=640000, currency=800, cooldown=3600, delay=260 },
        { name='Jester Malatrix', gid=33, tier=2, hp=640000, currency=800, cooldown=3600 },
        { name='Immanibugard', gid=34, tier=2, hp=640000, currency=800, cooldown=3600 },
        { name='Beist', gid=35, tier=2, hp=640000, currency=800, cooldown=3600 },
        -- Tier 3 (retail 135 + HELM NMs) -------------------------------
        { name='Fleetstalker', gid=61, tier=3, hp=1100000, currency=1300, cooldown=5400, drops = { { id=27605, name='Penetrating Cape' }, { id=26958, name='Sweller\'s Harness' }, { id=20847, name='Router' }, { id=27104, name='Shrieker\'s Cuffs' } } },
        { name='Shockmaw', gid=62, tier=3, hp=1100000, currency=1300, cooldown=5400, drops = { { id=27464, name='Inspirited Boots' }, { id=27289, name='Doyen Pants' }, { id=27511, name='Dampener\'s Torque' }, { id=20938, name='Annealed Lance' } } },
        { name='Urmahlullu', gid=63, tier=3, hp=1100000, currency=1300, cooldown=5400, delay=240, spellList=5, mp=9999, drops = { { id=26963, name='Onca Suit' }, { id=28415, name='Eschan Stone' }, { id=27783, name='Skormoth Mask' }, { id=20523, name='Chastisers' } } },
        { name='Alpluachra', gid=52, tier=3, hp=1100000, currency=1300, cooldown=5400, drops = { { id=28477, name='Hermetic Earring' }, { id=26960, name='Annointed Kalasiris' } } },
        { name='Bucca', gid=50, tier=3, hp=1100000, currency=1300, cooldown=5400, drops = { { id=28477, name='Hermetic Earring' }, { id=26960, name='Annointed Kalasiris' } } },
        { name='Puca', gid=51, tier=3, hp=1100000, currency=1300, cooldown=5400, drops = { { id=28477, name='Hermetic Earring' }, { id=26960, name='Annointed Kalasiris' } } },
        { name='Blazewing', gid=49, tier=3, hp=1100000, currency=1300, cooldown=5400, drops = { { id=22253, name='Falcon Eye' }, { id=26959, name='Kubira Meikogai' } } },
        { name='Pazuzu', gid=53, tier=3, hp=1100000, currency=1300, cooldown=5400, drops = { { id=27514, name='Empath Necklace' }, { id=26961, name='Makora Meikogai' } } },
        { name='Wrathare', gid=54, tier=3, hp=1100000, currency=1300, cooldown=5400, drops = { { id=27555, name='Warden\'s Ring' }, { id=26962, name='Enforcer\'s Harness' } } },
        { name='Voso', gid=32, tier=3, hp=1100000, currency=1500, cooldown=5400 },
        -- Boss ---------------------------------------------------------
        { name='Azi Dahaka', gid=64, tier=4, hp=3000000, currency=5000, cooldown=86400 },
    },
    [RUAUN] = {
        ...
        -- Tier 2 (retail 125) ------------------------------------------
        { name='Palila', gid=57, tier=2, hp=760000, currency=1050, cooldown=3600, drops = { { id=20700, name='Nixxer' }, { id=20979, name='Aizushintogo' }, { id=20519, name='Hammerfists' }, { id=20845, name='Instigator' } } },
        { name='Hanbi', gid=59, tier=2, hp=760000, currency=1050, cooldown=3600, drops = { { id=20597, name='Enchufla' }, { id=21149, name='Espiritus' }, { id=21150, name='Akademos' }, { id=20937, name='Rhomphaia' } } },
        { name='Yilan', gid=61, tier=2, hp=760000, currency=1050, cooldown=3600, delay=260, drops = { { id=20701, name='Iris' }, { id=21151, name='Lathi' }, { id=20702, name='Emissary' }, { id=21084, name='Queller Rod' } } },
        { name='Amymone', gid=63, tier=2, hp=760000, currency=1050, cooldown=3600, drops = { { id=21482, name='Compensator' }, { id=20892, name='Deathbane' }, { id=20598, name='Shijo' }, { id=21698, name='Bidenhander' } } },
        { name='Naphula', gid=65, tier=2, hp=760000, currency=1050, cooldown=3600, drops = { { id=21085, name='Solstice' }, { id=20797, name='Skullrender' }, { id=21215, name='Vijaya Bow' } } },
        { name='Kammavaca', gid=67, tier=2, hp=760000, currency=1050, cooldown=3600, drops = { { id=20599, name='Kali' }, { id=21027, name='Ichigohitofuri' }, { id=20520, name='Midnights' } } },
        -- Tier 3 (retail 135) ------------------------------------------
        { name='Pakecet', gid=72, tier=3, hp=1300000, currency=1800, cooldown=7200, drops = { { id=27614, name='Xucau Mantle' }, { id=27490, name='Tutyr Sabots' }, { id=25703, name='Uac Jerkin' }, { id=27134, name='Kurys Gloves' } } },
        { name='Duke Vepar', gid=74, tier=3, hp=1300000, currency=1800, cooldown=7200, drops = { { id=20518, name='Eshus' }, { id=27319, name='Obatala Subligar' }, { id=25706, name='Shango Robe' }, { id=28411, name='Yemaya Belt' } } },
        { name='Vir\'ava', gid=76, tier=3, hp=1300000, currency=1800, cooldown=7200, drops = { { id=21083, name='Sucellus' }, { id=27538, name='Lempo Earring' }, { id=25704, name='Abnoba Kaftan' }, { id=27320, name='Selvans Subligar' } } },
        -- Tier 3 (Ark Angels, retail 140) ------------------------------
        { name='Ark Angel EV', label='AA EV', gid=90, tier=3, hp=1600000, currency=2200, cooldown=7200, drops = { { id=20704, name='Deacon Sword' }, { id=22265, name='Elis Tome' } } },
        { name='Ark Angel GK', label='AA GK', gid=91, tier=3, hp=1600000, currency=2200, cooldown=7200, drops = { { id=21028, name='Deacon Blade' }, { id=6415, name='Seki Shuriken Pouch' } } },
        { name='Ark Angel HM', label='AA HM', gid=85, tier=3, hp=1600000, currency=2200, cooldown=7200, drops = { { id=20703, name='Deacon Saber' }, { id=26322, name='Kerygma Belt' }, { id=27744, name='Lithelimb Cap' } } },
        { name='Ark Angel MR', label='AA MR', gid=87, tier=3, hp=1600000, currency=2200, cooldown=7200, drops = { { id=20798, name='Deacon Tabar' }, { id=27617, name='Enuma Mantle' } } },
        { name='Ark Angel TT', label='AA TT', gid=86, tier=3, hp=1600000, currency=2200, cooldown=7200, drops = { { id=20894, name='Deacon Scythe' }, { id=26162, name='Rahab Ring' }, { id=28616, name='Fravashi Mantle' } } },
        -- Tier 3 (Heavenly Beasts, retail 140/150) ---------------------
        { name='Byakko-Escha', label='Byakko', gid=78, tier=3, hp=1400000, currency=2000, cooldown=7200, drops = { { id=22256, name='Jokushunoibuki' }, { id=20846, name='Jokushuono' }, { id=27318, name='Jokushu Haidate' }, { id=27525, name='Jokushu Chain' } } },
        { name='Genbu-Escha', label='Genbu', gid=79, tier=3, hp=1400000, currency=2000, cooldown=7200, delay=240, drops = { { id=22257, name='Genmeinoibuki' }, { id=27645, name='Genmei Shield' }, { id=25629, name='Genmei Kabuto' }, { id=27539, name='Genmei Earring' } } },
        { name='Seiryu-Escha', label='Seiryu', gid=80, tier=3, hp=1400000, currency=2000, cooldown=7200, delay=240, drops = { { id=22259, name='Kobonoibuki' }, { id=20699, name='Koboto' }, { id=27133, name='Kobo Kote' }, { id=26320, name='Kobo Obi' } } },
        { name='Suzaku-Escha', label='Suzaku', gid=81, tier=3, hp=1400000, currency=2000, cooldown=7200, drops = { { id=22258, name='Shukuyunoibuki' }, { id=20893, name='Shukuyu\'s Scythe' }, { id=27489, name='Shukuyu Sune-Ate' }, { id=26161, name='Shukuyu Ring' } } },
        { name='Kirin', gid=82, tier=3, hp=2400000, currency=3500, cooldown=7200, delay=240 },
        { name='Kouryu', gid=84, tier=3, hp=2000000, currency=3500, cooldown=7200, drops = { { id=27615, name='Reiki Cloak' }, { id=20842, name='Reikiono' }, { id=21152, name='Reikikon' }, { id=20690, name='Reikiko' }, { id=26321, name='Reiki Yotai' }, { id=25702, name='Reiki Osode' } } },
        -- Boss ---------------------------------------------------------
        { name='Warder of Courage', label='Courage', gid=93, tier=4, hp=4000000, currency=8000, cooldown=86400, drops = { { id=22196, name='Alber Strap' }, { id=20887, name='Dacnomania' }, { id=20932, name='Habile Mazrak' }, { id=19209, name='Molybdosis' }, { id=27545, name='Telos Earring' }, { id=25728, name='Zendik Robe' } } },
    },
    [REISEN] = {
        -- Tier 1 (retail 119) ------------------------------------
        ...
        -- Tier 2 (retail 129) ------------------------------------
        { name='Strophadia', gid=57, tier=2, hp=900000, currency=1200, cooldown=3600, drops = { { id=22134, name='Holliday' }, { id=21854, name='Reienkyo' }, { id=20579, name='Skinflayer' }, { id=27547, name='Dignitary\'s Earring' } } },
        { name='Gajasimha', gid=58, tier=2, hp=900000, currency=1200, cooldown=3600, drops = { { id=20505, name='Condemners' }, { id=21804, name='Obschine' }, { id=26174, name='Persis Ring' }, { id=22113, name='Teller' } } },
        { name='Ironside', gid=59, tier=2, hp=900000, currency=1200, cooldown=3600, drops = { { id=20677, name='Colada' }, { id=26019, name='Homeric Gorget' }, { id=21904, name='Kanaria' } } },
        { name='Sarsaok', gid=60, tier=2, hp=900000, currency=1200, cooldown=3600, drops = { { id=22271, name='Pemphredo Tathlum' }, { id=21021, name='Umaru' }, { id=21686, name='Zulfiqar' } } },
        { name='Old Shuck', gid=61, tier=2, hp=900000, currency=1200, cooldown=3600, drops = { { id=21746, name='Digirbalag' }, { id=21072, name='Gada' }, { id=26242, name='Phalangite Mantle' } } },
        { name='Bashmu', gid=62, tier=2, hp=900000, currency=1200, cooldown=3600, drops = { { id=21754, name='Aganoshe' }, { id=22054, name='Grioavolr' }, { id=26328, name='Sarissaphoroi Belt' } } },
        -- Tier 3 (retail 135) ------------------------------------
        { name='Maju', gid=63, tier=3, hp=1400000, currency=2000, cooldown=5400, drops = { { id=26175, name='Hetairoi Ring' }, { id=25719, name='Merlinic Jubbah' }, { id=25716, name='Odyssean Chestplate' }, { id=26243, name='Perimede Cape' } } },
        { name='Yakshi', gid=64, tier=3, hp=1400000, currency=2000, cooldown=5400, drops = { { id=26020, name='Ainia Collar' }, { id=25720, name='Chironic Doublet' }, { id=22199, name='Thrace Strap' }, { id=25717, name='Valorous Mail' } } },
        { name='Neak', gid=65, tier=3, hp=1400000, currency=2000, cooldown=5400, drops = { { id=26244, name='Agema Cape' }, { id=25718, name='Herculean Vest' }, { id=26329, name='Luminary Sash' } } },
        -- Apex / HELM bosses (Aeonic-tier) -----------------------
        { name='Teles', gid=66, tier=4, hp=2800000, currency=4500, cooldown=86400, drops = { { id=27143, name='Composer\'s Mitts' }, { id=27499, name='Composer\'s Sabots' }, { id=20889, name='Misanthropy' }, { id=20592, name='Sangoma' } } },
        { name='Zerde', gid=67, tier=4, hp=2800000, currency=4500, cooldown=86400, drops = { { id=25854, name='Arjuna Breeches' }, { id=25760, name='Mrigavyadha Gloves' }, { id=20506, name='Suwaiyas' }, { id=25721, name='Vedic Coat' } } },
        { name='Vinipata', gid=71, tier=4, hp=2800000, currency=4500, cooldown=86400, drops = { { id=21022, name='Shishio' }, { id=21905, name='Taka' }, { id=21073, name='Izcalli' }, { id=25655, name='Ipoca Beret' } } },
        { name='Schah', gid=74, tier=4, hp=2800000, currency=4500, cooldown=86400, drops = { { id=21687, name='Takoba' }, { id=22055, name='Oranyan' }, { id=25730, name='Nzingha Cuirass' }, { id=25920, name='Ahosi Leggings' } } },
        { name='Albumen', gid=80, tier=4, hp=2800000, currency=4500, cooldown=86400, delay=240, drops = { { id=25921, name='Skaoi Boots' }, { id=25656, name='Ynglinga Sallet' }, { id=21747, name='Freydis' }, { id=22114, name='Steinthor' } } },
        { name='Onychophora', gid=85, tier=4, hp=2800000, currency=4500, cooldown=86400, drops = { { id=20678, name='Firangi' }, { id=22056, name='Gozuki Mezuki' }, { id=21855, name='Lembing' }, { id=25922, name='Navon Crackows' } } },
        { name='Erinys', gid=87, tier=4, hp=2800000, currency=4500, cooldown=86400, drops = { { id=21755, name='Hodadenon' }, { id=25761, name='Iktomi Dastanas' }, { id=22119, name='Wochowsen' }, { id=25731, name='Sayadio\'s Kaftan' } } },
    },
}
