...
catalog.vendorItemsAuto =
{
    ...
    { id =  21870, name = 'Exalted Spear +1'                  , cost =  500, stats = { 'WS score 278', 'Weapons top-5 (Polearms)', 'Jobs: WAR/PLD/SAM/DRG' } },
    ...
    { id =  22136, name = 'Arasy Gun +1'                      , cost =  250, stats = { 'WS score 144', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
