...
-- 109 gear + 22 Sortie earrings = 131 items.
catalog.vendorItemsAuto =
{
    { id =  13606, name = 'Judges Cape'                       , cost =  800, stats = { 'DPS score 1100', 'Accessory top-5 (back)', 'Jobs: All' } },
    ...
    { id =  23716, name = 'Volte Haubert'                     , cost =  500, stats = { 'TANK score 562', 'Armor top-5 (body)', 'Jobs: WAR/PLD/DRK' } },
    { id =  23765, name = 'Mpacas Doublet'                    , cost =  500, stats = { 'TANK score 509', 'Armor top-5 (body)', 'Jobs: MNK/SAM/NIN/PUP' } },
    { id =  25784, name = 'Mallquis Saio +1'                  , cost =  500, stats = { 'CASTER score 502', 'Armor top-5 (body)', 'Jobs: BLM/SCH/GEO' } },
    ...
    { id =  24179, name = 'Duty Sollerets'                    , cost =  500, stats = { 'DPS score 360', 'Armor top-5 (feet)', 'Jobs: MNK/THF/BST/PUP/DNC' } },
    ...
    { id =  21683, name = 'Ragnarok 119 Iii'                  , cost =  500, stats = { 'WS score 296', 'Weapons top-5 (Great Swords)', 'Jobs: WAR/PLD/DRK' } },
    ...
    { id =  21660, name = 'Beryllium Sword +1'                , cost =  350, stats = { 'WS score 253', 'Weapons top-5 (Great Swords)', 'Jobs: WAR/PLD/DRK/RUN' } },
    ...
    { id =  22115, name = 'Yoichinoyumi 119 Iii'              , cost =  350, stats = { 'WS score 180', 'Weapons top-5 (Archery)', 'Jobs: RNG/SAM' } },
    ...
    { id =  22107, name = 'Ullr'                              , cost =  350, stats = { 'WS score 172', 'Weapons top-5 (Archery)', 'Jobs: WAR/RDM/THF/PLD/DRK/BST/RNG/SAM/NIN' } },
    ...
    { id =  21705, name = 'Arasy Tabar +1'                    , cost =  350, stats = { 'WS score 164', 'Weapons top-5 (Axes)', 'Jobs: WAR/BST' } },
    ...
    { id =  27615, name = 'Reiki Cloak'                       , cost =  350, stats = { 'TANK score 153', 'Accessory top-5 (back)', 'Jobs: WAR/MNK/RDM/THF/PLD/DRK/BST/BRD/RNG/SAM/NIN/DRG/BLU/COR/DNC/RUN' } },
    { id =  22129, name = 'Yoichinoyumi 119 Iii Aug'          , cost =  350, stats = { 'WS score 152', 'Weapons top-5 (Archery)', 'Jobs: RNG/SAM' } },
    { id =  21296, name = 'Chrono Bullet'                     , cost =  250, stats = { 'DPS score 150', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
    { id =  21227, name = 'Hangaku-No-Yumi'                   , cost =  250, stats = { 'WS score 146', 'Weapons top-5 (Archery)', 'Jobs: RNG/SAM' } },
    { id =  21269, name = 'Armageddon'                        , cost =  250, stats = { 'WS score 146', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
    { id =  22126, name = 'Exalted Bow +1'                    , cost =  250, stats = { 'WS score 145', 'Weapons top-5 (Archery)', 'Jobs: WAR/RDM/THF/PLD/DRK/BST/RNG/SAM/NIN' } },
    ...
    { id =  22136, name = 'Arasy Gun +1'                      , cost =  250, stats = { 'WS score 134', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
    ...
    { id =  22134, name = 'Holliday'                          , cost =  250, stats = { 'WS score 106', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
    ...
    { id =  26361, name = 'Gerdr Belt +1'                     , cost =  250, stats = { 'DPS score 72', 'Accessory top-5 (waist)', 'Jobs: WAR/MNK/RDM/THF/PLD/DRK/BST/BRD/SAM/NIN/DRG/BLU/COR/DNC/RUN' } },
