...
catalog.vendorItemsAuto =
{
    ...
    { id =  24139, name = 'Prestige Platemail'                , cost =  500, stats = { 'CASTER score 430', 'Armor top-5 (body)', 'Jobs: WHM/RDM/PLD/DRK/BLU/RUN' } },
    { id =  23766, name = 'Agwus Robe'                        , cost =  500, stats = { 'CASTER score 416', 'Armor top-5 (body)', 'Jobs: BLM/SCH/GEO/RUN' } },
    ...
    { id =  25554, name = 'Ea Hat +1'                         , cost =  500, stats = { 'CASTER score 332', 'Armor top-5 (head)', 'Jobs: BLM/RDM/GEO' } },
    { id =  23797, name = 'Crepuscular Helm'                  , cost =  500, stats = { 'TANK score 327', 'Armor top-5 (head)', 'Jobs: WAR/PLD/DRK/BST/SAM/DRG' } },
    { id =  23778, name = 'Sakpatas Cuisses'                  , cost =  500, stats = { 'TANK score 326', 'Armor top-5 (legs)', 'Jobs: WAR/PLD/DRK' } },
    { id =  24188, name = 'Clemency Kote'                     , cost =  500, stats = { 'DD score 314', 'Armor top-5 (hands)', 'Jobs: RNG/SAM/DRG/COR' } },
    { id =  23718, name = 'Volte Gloves'                      , cost =  500, stats = { 'CASTER score 307', 'Armor top-5 (hands)', 'Jobs: WHM/BLM/RDM/BRD/SMN/SCH/GEO' } },
    { id =  24134, name = 'Revelation Sabatons'               , cost =  500, stats = { 'DD score 302', 'Armor top-5 (feet)', 'Jobs: WAR/BRD/NIN' } },
    { id =  24133, name = 'Perfection Sabatons'               , cost =  500, stats = { 'DD score 290', 'Armor top-5 (feet)', 'Jobs: WAR/BRD/NIN' } },
    ...
    { id =  21527, name = 'Sakpatas Fists'                    , cost =  350, stats = { 'DD score 210', 'Weapons top-5 (H2H)', 'Jobs: MNK/PUP' } },
    ...
    { id =  21707, name = 'Barbarity +1'                      , cost =  350, stats = { 'DD score 195', 'Weapons top-5 (Axes)', 'Jobs: WAR/BST' } },
    ...
    { id =  22136, name = 'Arasy Gun +1'                      , cost =  250, stats = { 'DD score 78', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
...
catalog.itemTypeMap =
{
    ...
    [21684] = 'Weapons/Great Sword',
    [20745] = 'Weapons/Great Sword',
