...
-- 110 gear + 22 Sortie earrings = 132 items.
catalog.vendorItemsAuto =
{
    ...
    { id =  21152, name = 'Reikikon'                          , cost =  800, stats = { 'CASTER score 986', 'Weapons top-5 (Staves)', 'Jobs: MNK/WHM/BLM/PLD/DRG/SMN/SCH/GEO' } },
    ...
    { id =  22030, name = 'Kaja Rod'                          , cost =  800, stats = { 'CASTER score 954', 'Weapons top-5 (Clubs)', 'Jobs: WHM/BLM/RDM/SMN/BLU/SCH/GEO' } },
    ...
    { id =  21619, name = 'Eletta Sword'                      , cost =  800, stats = { 'CASTER score 920', 'Weapons top-5 (Swords)', 'Jobs: WAR/RDM/THF/PLD/DRK/BST/BRD/RNG/NIN/DRG/BLU/COR/RUN' } },
    ...
    { id =  13606, name = 'Judges Cape'                       , cost =  800, stats = { 'DPS score 800', 'Accessory top-5 (back)', 'Jobs: All' } },
    { id =  26963, name = 'Onca Suit'                         , cost =  800, stats = { 'DPS score 776', 'Armor top-5 (body)', 'Jobs: WAR/MNK/WHM/BLM/RDM/THF/PLD/DRK/BST/BRD/RNG/SAM/NIN/DRG/SMN/BLU/COR/PUP/DNC/SCH/GEO/RUN' } },
    { id =  25784, name = 'Mallquis Saio +1'                  , cost =  800, stats = { 'CASTER score 502', 'Armor top-5 (body)', 'Jobs: BLM/SCH/GEO' } },
    { id =  13505, name = 'Judges Ring'                       , cost =  500, stats = { 'TANK score 500', 'Accessory top-5 (ring)', 'Jobs: All' } },
    { id =  23716, name = 'Volte Haubert'                     , cost =  500, stats = { 'TANK score 476', 'Armor top-5 (body)', 'Jobs: WAR/PLD/DRK' } },
    { id =  25878, name = 'Mallquis Trews +1'                 , cost =  500, stats = { 'CASTER score 470', 'Armor top-5 (legs)', 'Jobs: BLM/SCH/GEO' } },
    { id =  23767, name = 'Bunzis Robe'                       , cost =  500, stats = { 'CASTER score 462', 'Armor top-5 (body)', 'Jobs: WHM/RDM/BRD/SMN' } },
    { id =  23781, name = 'Bunzis Pants'                      , cost =  500, stats = { 'CASTER score 459', 'Armor top-5 (legs)', 'Jobs: WHM/RDM/BRD/SMN' } },
    { id =  24139, name = 'Prestige Platemail'                , cost =  500, stats = { 'CASTER score 454', 'Armor top-5 (body)', 'Jobs: WHM/RDM/PLD/DRK/BLU/RUN' } },
    ...
    { id =  23779, name = 'Mpacas Hose'                       , cost =  500, stats = { 'TANK score 385', 'Armor top-5 (legs)', 'Jobs: MNK/SAM/NIN/PUP' } },
    { id =  25898, name = 'Arke Cosciales +1'                 , cost =  500, stats = { 'TANK score 382', 'Armor top-5 (legs)', 'Jobs: WAR/PLD/DRG' } },
    { id =  25945, name = 'Mallquis Clogs +1'                 , cost =  500, stats = { 'CASTER score 382', 'Armor top-5 (feet)', 'Jobs: BLM/SCH/GEO' } },
    { id =  24270, name = 'Null Masque'                       , cost =  500, stats = { 'TANK score 372', 'Armor top-5 (head)', 'Jobs: WAR/MNK/WHM/BLM/RDM/THF/PLD/DRK/BST/BRD/RNG/SAM/NIN/DRG/SMN/BLU/COR/PUP/DNC/SCH/GEO/RUN' } },
    ...
    { id =  25629, name = 'Genmei Kabuto'                     , cost =  500, stats = { 'TANK score 358', 'Armor top-5 (head)', 'Jobs: WAR/MNK/BST/BRD/RNG/SAM/NIN' } },
    { id =  23772, name = 'Mpacas Gloves'                     , cost =  500, stats = { 'TANK score 350', 'Armor top-5 (hands)', 'Jobs: MNK/SAM/NIN/PUP' } },
    { id =  23771, name = 'Sakpatas Gauntlets'                , cost =  500, stats = { 'TANK score 350', 'Armor top-5 (hands)', 'Jobs: WAR/PLD/DRK' } },
    ...
    { id =  24134, name = 'Revelation Sabatons'               , cost =  500, stats = { 'DPS score 317', 'Armor top-5 (feet)', 'Jobs: WAR/BRD/NIN' } },
    ...
    { id =  24133, name = 'Perfection Sabatons'               , cost =  500, stats = { 'DPS score 302', 'Armor top-5 (feet)', 'Jobs: WAR/BRD/NIN' } },
    { id =  21974, name = 'Kaja Tachi'                        , cost =  500, stats = { 'WS score 300', 'Weapons top-5 (Great Katana)', 'Jobs: SAM/NIN' } },
    { id =  20632, name = 'Vanir Knife'                       , cost =  500, stats = { 'CASTER score 295', 'Weapons top-5 (Daggers)', 'Jobs: WAR/RDM/THF/BST/BRD/RNG/NIN/COR/DNC' } },
    { id =  21567, name = 'Gletis Knife'                      , cost =  500, stats = { 'DPS score 278', 'Weapons top-5 (Daggers)', 'Jobs: RDM/THF/BRD/RNG/NIN/COR/DNC' } },
    { id =  21673, name = 'Kaja Claymore'                     , cost =  500, stats = { 'WS score 276', 'Weapons top-5 (Great Swords)', 'Jobs: WAR/PLD/DRK/RUN' } },
    ...
    { id =  21683, name = 'Ragnarok 119 Iii'                  , cost =  350, stats = { 'WS score 270', 'Weapons top-5 (Great Swords)', 'Jobs: WAR/PLD/DRK' } },
    ...
    { id =  21527, name = 'Sakpatas Fists'                    , cost =  350, stats = { 'WS score 258', 'Weapons top-5 (H2H)', 'Jobs: MNK/PUP' } },
    { id =  21663, name = 'Raetic Algol +1'                   , cost =  350, stats = { 'WS score 256', 'Weapons top-5 (Great Swords)', 'Jobs: WAR/PLD/DRK/RUN' } },
    { id =  21964, name = 'Beryllium Tachi +1'                , cost =  350, stats = { 'WS score 256', 'Weapons top-5 (Great Katana)', 'Jobs: SAM/NIN' } },
    { id =  26023, name = 'Sanctity Necklace'                 , cost =  350, stats = { 'CASTER score 252', 'Accessory top-5 (neck)', 'Jobs: All' } },
    { id =  21870, name = 'Exalted Spear +1'                  , cost =  350, stats = { 'WS score 248', 'Weapons top-5 (Polearms)', 'Jobs: WAR/PLD/SAM/DRG' } },
    { id =  21766, name = 'Hepatizon Axe +1'                  , cost =  350, stats = { 'WS score 243', 'Weapons top-5 (Great Axes)', 'Jobs: WAR/DRK/RUN' } },
    { id =  21707, name = 'Barbarity +1'                      , cost =  350, stats = { 'WS score 242', 'Weapons top-5 (Axes)', 'Jobs: WAR/BST' } },
    { id =  21816, name = 'Maliya Sickle +1'                  , cost =  350, stats = { 'WS score 242', 'Weapons top-5 (Scythes)', 'Jobs: WAR/BLM/DRK/BST' } },
    ...
    { id =  21655, name = 'Arasy Claymore +1'                 , cost =  350, stats = { 'WS score 230', 'Weapons top-5 (Great Swords)', 'Jobs: WAR/PLD/DRK/RUN' } },
    ...
    { id =  26269, name = 'Moonlight Cape'                    , cost =  350, stats = { 'TANK score 171', 'Accessory top-5 (back)', 'Jobs: All' } },
    { id =  21752, name = 'Farsha'                            , cost =  350, stats = { 'WS score 168', 'Weapons top-5 (Axes)', 'Jobs: WAR/BST' } },
    { id =  21720, name = 'Eletta Axe'                        , cost =  350, stats = { 'WS score 163', 'Weapons top-5 (Axes)', 'Jobs: WAR/DRK/BST/RNG/RUN' } },
    { id =  26341, name = 'Moonbow Belt +1'                   , cost =  350, stats = { 'DPS score 162', 'Accessory top-5 (waist)', 'Jobs: MNK/PUP' } },
    { id =  21972, name = 'Ajja Tachi'                        , cost =  350, stats = { 'WS score 161', 'Weapons top-5 (Great Katana)', 'Jobs: SAM/NIN' } },
    { id =  22115, name = 'Yoichinoyumi 119 Iii'              , cost =  350, stats = { 'WS score 152', 'Weapons top-5 (Archery)', 'Jobs: RNG/SAM' } },
    { id =  22129, name = 'Yoichinoyumi 119 Iii Aug'          , cost =  350, stats = { 'WS score 152', 'Weapons top-5 (Archery)', 'Jobs: RNG/SAM' } },
    { id =  27615, name = 'Reiki Cloak'                       , cost =  350, stats = { 'TANK score 150', 'Accessory top-5 (back)', 'Jobs: WAR/MNK/RDM/THF/PLD/DRK/BST/BRD/RNG/SAM/NIN/DRG/BLU/COR/DNC/RUN' } },
    { id =  21296, name = 'Chrono Bullet'                     , cost =  350, stats = { 'DPS score 150', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
    { id =  22107, name = 'Ullr'                              , cost =  250, stats = { 'WS score 149', 'Weapons top-5 (Archery)', 'Jobs: WAR/RDM/THF/PLD/DRK/BST/RNG/SAM/NIN' } },
    { id =  21227, name = 'Hangaku-No-Yumi'                   , cost =  250, stats = { 'WS score 146', 'Weapons top-5 (Archery)', 'Jobs: RNG/SAM' } },
    { id =  26004, name = 'Lissome Necklace'                  , cost =  250, stats = { 'DPS score 140', 'Accessory top-5 (neck)', 'Jobs: All' } },
    { id =  21325, name = 'Devastating Bullet'                , cost =  250, stats = { 'DPS score 138', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
    { id =  21229, name = 'Cibitshavore'                      , cost =  250, stats = { 'WS score 130', 'Weapons top-5 (Archery)', 'Jobs: RNG/SAM' } },
    { id =  22136, name = 'Arasy Gun +1'                      , cost =  250, stats = { 'WS score 109', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
    ...
    { id =  21485, name = 'Fomalhaut'                         , cost =  250, stats = { 'WS score 104', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
    ...
    { id =  22134, name = 'Holliday'                          , cost =  250, stats = { 'WS score 84', 'Weapons top-5 (Marksmanship)', 'Jobs: RNG/COR' } },
    { id =  25497, name = 'Dragoons Collar +2'                , cost =  250, stats = { 'WS score 83', 'Accessory top-5 (neck)', 'Jobs: DRG' } },
    { id =  26321, name = 'Reiki Yotai'                       , cost =  250, stats = { 'DPS score 79', 'Accessory top-5 (waist)', 'Jobs: WAR/MNK/RDM/THF/PLD/DRK/BST/BRD/SAM/NIN/DRG/BLU/COR/DNC/RUN' } },
    ...
    { id =  26191, name = 'Regal Ring'                        , cost =  250, stats = { 'WS score 70', 'Accessory top-5 (ring)', 'Jobs: WAR/MNK/THF/PLD/DRK/BST/RNG/SAM/NIN/DRG/COR/PUP/DNC/RUN' } },
    { id =  28408, name = 'Grunfeld Rope'                     , cost =  250, stats = { 'DPS score 67', 'Accessory top-5 (waist)', 'Jobs: All' } },
    { id =  10769, name = 'Gelatinous Ring +1'                , cost =  250, stats = { 'TANK score 64', 'Accessory top-5 (ring)', 'Jobs: All' } },
...
catalog.itemTypeMap =
{
    ...
    [13606] = 'Accessories/Back',
    [26963] = 'Armor/Body',
    [25784] = 'Armor/Body',
    [13505] = 'Accessories/Ring',
    [23716] = 'Armor/Body',
    [25878] = 'Armor/Legs',
    [23767] = 'Armor/Body',
    [23781] = 'Armor/Legs',
