...
VALUES
    ...
    ('skoll', 901, 400, 1, 255),   -- Blade Madrigal  (double accuracy layer)
...
DELETE FROM mob_spell_lists WHERE spell_list_id = 901 AND spell_id IN (894, 388, 844, 884, 216, 842, 470, 401);
