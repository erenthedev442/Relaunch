...
--   Female (race 2), face F1A, no weapon, wearing Snow Bunny Hat (head) +
...
--   item_equipment.MId (head 142, body 157, legs 157 -- Hume Top & Shorts are
...
VALUES
    ...
    ('skoll', 901,   2, 11, 255), -- Cure II
    ('skoll', 901,   3, 21, 255), -- Cure III
    ('skoll', 901,   4, 41, 255), -- Cure IV
    ('skoll', 901,   5, 61, 255), -- Cure V
    ('skoll', 901,   6, 80, 255), -- Cure VI
	('skoll', 901,   7, 16, 255), -- Cureaga

    -- Protectra family — WHM
    ('skoll', 901, 125,  7, 255), -- Protectra
    ('skoll', 901, 126, 27, 255), -- Protectra II
    ('skoll', 901, 127, 47, 255), -- Protectra III
    ('skoll', 901, 128, 63, 255), -- Protectra IV
    ('skoll', 901, 129, 75, 255), -- Protectra V

    -- Shellra family — WHM
    ('skoll', 901, 130, 17, 255), -- Shellra
    ('skoll', 901, 131, 37, 255), -- Shellra II
    ('skoll', 901, 132, 57, 255), -- Shellra III
    ('skoll', 901, 133, 68, 255), -- Shellra IV
    ('skoll', 901, 134, 75, 255), -- Shellra V

    -- Raise family — WHM
    ('skoll', 901,  12, 25, 255), -- Raise
    ('skoll', 901,  13, 56, 255), -- Raise II
    ('skoll', 901, 140, 70, 255), -- Raise III
    ('skoll', 901, 494, 99, 255), -- Arise

    -- Haste — WHM
    ('skoll', 901,  57, 40, 255), -- Haste
	('skoll', 901, 511, 65, 255),   -- Haste II

    -- Mage's Ballad family — BRD acquisition levels
    ('skoll', 901, 386, 25, 255), -- Mage's Ballad
    ('skoll', 901, 387, 55, 255), -- Mage's Ballad II
    ('skoll', 901, 388, 85, 255), -- Mage's Ballad III

    -- Intelligence Etudes — BRD acquisition levels
    ('skoll', 901, 428, 26, 255), -- Learned Etude
    ('skoll', 901, 435, 66, 255), -- Sage Etude

    -- Madrigal family — BRD acquisition levels
    ('skoll', 901, 399, 11, 255), -- Sword Madrigal
    ('skoll', 901, 400, 51, 255), -- Blade Madrigal

    -- Valor Minuet family — BRD acquisition levels
    ('skoll', 901, 394,  3, 255), -- Valor Minuet
    ('skoll', 901, 395, 23, 255), -- Valor Minuet II
    ('skoll', 901, 396, 43, 255), -- Valor Minuet III
    ('skoll', 901, 397, 63, 255), -- Valor Minuet IV
    ('skoll', 901, 398, 87, 255), -- Valor Minuet V

    -- Prelude
    ('skoll', 901, 401, 31, 255), -- Hunter's Prelude
    
	-- Remove ailments.
    ('skoll', 901, 143, 32, 255),   -- Erase
    ('skoll', 901,  14, 6, 255),   -- Poisona
    ('skoll', 901,  15, 9, 255),   -- Paralyna
    ('skoll', 901,  16, 14, 255),   -- Blindna
    ('skoll', 901,  17, 19, 255),   -- Silena
    ('skoll', 901,  18, 39, 255),   -- Stona
    ('skoll', 901,  19, 34, 255),   -- Viruna
    ('skoll', 901,  20, 29, 255),   -- Cursna
    ('skoll', 901,  59, 15, 255),   -- Silence
    ('skoll', 901,  55, 10, 255),   -- Aquaveil     (self: casts can't be interrupted)
    ('skoll', 901, 260, 32, 255);   -- Dispel       (strip enemy buffs)
