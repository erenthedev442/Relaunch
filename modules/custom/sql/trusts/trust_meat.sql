...
VALUES
    ('meat', 899, 112, 37, 255),   -- Flash      (enmity + accuracy down)
    ('meat', 899, 106, 77, 255),   -- Phalanx    (flat physical damage cut)
    ('meat', 899,  97, 61, 255),   -- Reprisal   (block -> spike + damage cut)
	('meat', 899,   1, 5, 255),   -- Cure I
